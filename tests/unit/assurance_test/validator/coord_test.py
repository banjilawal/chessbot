...
from chess.exception.coord import RowBelowBoundsException, RowAboveBoundsException, ColumnBelowBoundsException, \
...
class CoordinateValidatorTest(unittest.TestCase):
    ...
    def test_validation_payload_equals_input_param(self):
        mock_coordinate = self.make_valid_mock_coordinate(3, 4)
