# src/operand/state/event/token/operand/state.py

"""
Module: operand.state.event.token.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from operand import EventTransition, Coord, HomeSquare, Rank, Team, Token
from setting import GameColor

@dataclass
class TokenEventTransition(EventTransition[Token]):
    """
    Role:
        -   Selection
        -   Routing mask
