# src/operand/state/team/roster/util/util.py

"""
Module: operand.state.team.roster.util.util
Author: Banji Lawal
Created: 2026-02-22
version: 1.0.0
"""
...
from operand.rank import RankService
from operand.catalog.formation import FormationKey, FormationService
from system import IdFactory, IdentityService, UpdateResult
from operand.state.team import FillingTeamRosterException, RosterRelationAnalysis, Team, TeamValidator
...
class RosterUtil:
    ...
    def fill_team_roster(
        ...
        for formation in formation_lookup_result.payload:
            ...
            # Build the token.
            token_build_result = team.roster.service.builder.build(
                owner=team,
