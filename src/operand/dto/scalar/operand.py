# src/operand/dto/scalar/operand.py

"""
Module: operand.dto.scalar.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class ScalarDtoOperand(DtoOperand[Scalar]):
    ...
    Responsibilities:
        1.  Dto for transporting either a Scalar or ScalarBlueprint
    ...
    @property
    def operand(self) -> [Scalar|ScalarBlueprint]:
