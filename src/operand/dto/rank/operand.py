# src/operand/dto/rank/operand.py

"""
Module: operand.dto.rank.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class RankDtoOperand(DtoOperand[Rank]):
    ...
    Responsibilities:
        1.  Dto for transporting either a Rank or RankBlueprint
    ...
    @property
    def operand(self) -> [Rank|RankBlueprint]:
