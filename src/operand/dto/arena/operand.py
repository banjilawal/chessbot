# src/operand/dto/arena/operand.py

"""
Module: operand.dto.arena.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class ArenaDtoOperand(DtoOperand[Arena]):
    ...
    Responsibilities:
        1.  Dto for transporting either a Arena or ArenaBlueprint
    ...
    @property
    def operand(self) -> [Arena|ArenaBlueprint]:
