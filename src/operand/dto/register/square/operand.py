# src/operand/dto/register/square/operand.py

"""
Module: operand.dto.register.square.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class SquareRegisterDtoOperand(RegisterEntityOperand[SquareRegister]):
    """
    Role:
        -   Addressing
        -   Data-Holder
    ...
    Responsibilities:
        1.  Dto for transporting either an SquareRegister or SquareRegisterBlueprint
    ...
    @property
    def entity(self) -> [SquareRegister | SquareRegisterBlueprint]:
        if self.is_empty:
            return None
        if self.is_model_operand:
            return cast(SquareRegister, self.entity)
        return cast(SquareRegisterBlueprint, self.entity)
