# src/operand/dto/register/identity/operand.py

"""
Module: operand.dto.register.identity.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class IdentityRegisterDtoOperand(RegisterEntityOperand[IdentityRegister]):
    """
    Role:
        -   Addressing
        -   Data-Holder
    ...
    Responsibilities:
        1.  Dto for transporting either an IdentityRegister or IdentityRegisterBlueprint
