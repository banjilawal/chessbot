...
class HostageValidator(Validator[Hostage]):
    ...
    def validate(
        ...
        captured_square_validation = square_service.validator.build(candidate=manifest.captured_square)
        ...
        victor_square_validation = square_service.validator.build(candidate=manifest.victor_square)
        ...
        victor_validation = token_service.validator.search_service(candidate=manifest.victor)
