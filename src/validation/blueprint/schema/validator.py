# src/validation/blueprint/schema/validator.py

"""
Module: validation.blueprint.schema.validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class SchemaBlueprintValidator(BlueprintValidator[SchemaKey]):
    """
    ...
    def validate(
        ...
        """
        method = "SchemaBlueprintValidator.validate"
