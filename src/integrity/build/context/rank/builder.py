# src/integrity/build/context/rank/builder.py

"""
Module: integrity.build.context.rank.builder
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class RankContextBuilder(Builder[RankContext]):
   ...
   Responsibilities:
    ...
    def build(
        ...
        """
        method = "RankContextBuilder.build"
    ...
    def build_rank_search_context(
        ...
        try:
            rank_validation = rank_validator.search(rank)
