# src/logic/formation/validation/exception/validator.py

"""
Module: logic.formation.validation.exception.work
Author: Banji Lawal
Created: 2025-09-08
Version: 1.0.0
"""
...
class FormationValidationException(ValidationException):
    ...
    Responsibilities:
    1.  Identify the FormationValidator method where the exception failed.
