...
class SchemValidationExecutionRouteException(ResultException, ExecutionRouteException):
    ...
    Responsibilities:
    1.  Indicate that FormationValidator did not handle one of the paths necessary to assure a rank is a
    ...
    MSG = (
        "The FormationValidator did not handle one of the paths necessary to assure a rank is a Formation safe to use. "
