# src/logic/player/validation/exception/debug/null.py

"""
Module: logic.player.validation.exception.debug.null
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class NullPlayerException(NullException):
    ...
    Responsibilities:
    1.  Indicate that a player is null where it should not be.
