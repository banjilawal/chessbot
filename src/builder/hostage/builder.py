...
class HostageBuilder(Builder[Hostage]):
   ...
   Responsibilities:
    ...
    def build(
        ...
        captured_square_validation = square_service.run.execute(candidate=captured_square)
        ...
        prisoner_is_combatant_validation = token_service.run.verify_token_is_combatant(
            candidate=prisoner
        )
