   ...
   Responsibilities:
    ...
    def _run_build_param_checks(
       ...
       Action:
        ...
        coord_validation = tool.coord_service.execute.build(coord)
        ...
        board_validation = tool.board_service.execute.build(board)
        ...
        collision_detection_result = tool.collision_analyst.build(
            item_id=id,
            name=name,
            coord=coord,
            board=board
