# src/blueprint/pattern/blueprint.py

"""
Module: blueprint.pattern.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class SignatureBlueprint(Blueprint, ABC, Generic[T]):
    ...
    def __init__(self, model_class: Type[Signature], null_exception: SignatureNullException):
        super().__init__(model_class=model_class, null_exception=null_exception or SignatureNullException())
