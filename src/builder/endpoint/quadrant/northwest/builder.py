...
class NorthwestQuadrantEndpointBuilder:
    ...
    def __init__(
        ...
        self._delta = Vector(
            x=origin.x + 0,
            y=origin.y + QuadrantTerminus.NORTHWEST.vector.y,
        )
        self._terminus = Vector(
            x=self._origin.x,
            y=QuadrantTerminus.NORTHWEST.vector.y
        )
    ...
    # def execute(self) -> BuildResult[VectorRegister]:
    #     """
    #     Construct the endpoints for a NorthwesternQuadrant instance.
    #
    #     Action:
    ...
    #     Raises:
    #          NorthwesternQuadrantEndPointBuilderException
    #     """
