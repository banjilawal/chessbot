...
from err import SoutheastQuadrantEndPointBuilderException
...
class SoutheastQuadrantEndpointBuilder:
    """
    Role:
        -   Builder
    ...
    def __init__(
        ...
        self._delta = Vector(
            x=origin.x + QuadrantTerminus.SOUTHEAST.vector.x,
            y=origin.y + QuadrantTerminus.SOUTHEAST.vector.y,
        )
        self._terminus = Vector(
            x=self._origin.x,
            y=QuadrantTerminus.SOUTHEAST.vector.y
        )
    ...
    # def execute(self) -> BuildResult[VectorRegister]:
    #     """
    #     Construct the endpoints for a SoutheasternQuadrant instance.
    #
    #     Action:
    ...
    #     Raises:
    #          SoutheasternQuadrantEndPointBuilderException
    #     """
    ...
    #             SoutheastQuadrantEndPointBuilderException(
    #                 cls_mthd=method,
    #                 cls_name=self.__class__.__name__,
    #                 msg=SoutheastQuadrantEndPointBuilderException.MSG,
    #                 err_code=SoutheastQuadrantEndPointBuilderException.ERR_CODE,
    #                 ex=result.exception,
    #             )
    #         )
