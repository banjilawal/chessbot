# src/builder/endpoint/quadrant/southeast/builder.py

"""
Module: builder.endpoint.quadrant.southeast.builder
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class SoutheastQuadrantEndpointBuilder:
    ...
    Responsibilities:
        1.  Create a VectorRegister for the quadrant southeast of the origin.
    ...
    def __init__(
        ...
        self._terminus = QuadrantTerminus.SOUTHEAST.vector
    ...
    # def execute(self) -> BuildResult[VectorRegister]:
    #     """
    #     Construct the endpoints for a SoutheastQuadrant instance.
    #
    #     Action:
