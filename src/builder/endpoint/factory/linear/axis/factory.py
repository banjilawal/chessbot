# src/builder/endpoint/factory/linear/axis/factory.py

"""
Module: builder.endpoint.factory.linear.axis.factory
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class AxisEndpointFactory(LinearEndpointFactory):
    ...
    def __init__(
            ...
            west_axis_endpoint_builder: Optional[WestAxisEndpointBuilder] |
                                        None = SouthAxisEndpointBuilder(),
    ):
        """
        Args:
