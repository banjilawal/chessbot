# src/logic/board/validation/exception/flag/zero.py

"""
Module: logic.board.validation.exception.flag.zero
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# ZERO_BOARD_CONTEXT_FLAGS_EXCEPTION #======================#
class ZeroBoardContextFlagsException(DebugException):
    """
   ...
   None
    ...
    """
    MSG = "No BoardContext flags are enabled."
