# src/logic/player/validation/exception/exception.py

"""
Module: logic.player.validation.exception.exception
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class PlayerContextValidationException(ValidationException):
    ...
    Responsibilities:
    1.  Identify the PlayerValidator method where the exception failed.
