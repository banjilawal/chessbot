# src/logic/hostage/context/exception/anchor.py

"""
Module: logic.hostage.context.exception.anchor
Author: Banji Lawal
Created: 2025-10-01
version: 1.0.0
"""
...
class HostageContextException(AnchorException):
    ...
    Responsibilities:
    1.  Anchors HostageContext debug (layer-2) error state firing incident
        reports on
