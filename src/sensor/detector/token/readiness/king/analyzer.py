# src/sensor/analyzer/readiness/king/analyzer.py

"""
Module: sensor.analyzer.readiness.king.analyzer
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class KingReadinessAnalyzer(Analyzer):
    ...
    def execute(cls, subject: KingToken, ) -> AnalysisResult[TokenReadinessReport]:
        """
