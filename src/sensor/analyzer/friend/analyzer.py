# src/sensor/analyzer/friend/analyzer.py

"""
Module: sensor.analyzer.friend.analyzer
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class FriendshipAnalyzer(Analyzer):
    ...
    def _process_enemy_king(
        ...
        if king_status == SENSOR.FriendshipStatus.FREE_ENEMY_KING:
            return AnalysisResult.completed(
        ...
        if king_status == SENSOR.FriendshipStatus.CHECKMATED_ENEMY_KING:
            return AnalysisResult.completed(
    ...
    def _process_enemy_combatant(
        ...
        # Case: The enemy king is free.
        if combatant_status == SENSOR.FriendshipStatus.FREE_ENEMY_COMBATANT:
            return AnalysisResult.completed(
        ...
        if combatant_status == SENSOR.FriendshipStatus.ENEMY_PRISONER:
            return AnalysisResult.completed(
