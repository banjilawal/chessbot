# src/artifact/report/promotion/manager/report.py

"""
Module: artfifact.report.promotion.manager.report
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from artifcat.report.promotion.manager.state import PromotionDecision
