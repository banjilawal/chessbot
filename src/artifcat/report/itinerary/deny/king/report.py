# src/artifact/report/itinerary/deny/checked/report.py

"""
Module: artfifact.report.itinerary.deny.checked.report
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.model import KingToken, Square, Team, Token
from artifcat.report import ItineraryDenialReport
