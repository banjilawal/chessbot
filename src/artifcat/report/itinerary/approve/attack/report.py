# src/artifact/report/itinerary/approve/attack/report.py

"""
Module: artfifact.report.itinerary.approve.attack.report
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.model import CombatantToken, Square, Team
...
class AttackApproval(ItineraryApprovalReport):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, AttackApproval):
            return (
