# src/analyzer/relation/team/player/analyst.py

"""
Module: analyzer.relation.team.player.analyst
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class PlayerTeamRelationAnalyst(RelationAnalyst[Player, Team]):
    """
    ...
    def execute(
        ...
        player_validation = player_validator.build(candidate_primary)
        ...
        team_validation = player.teams.pair_service.run.search_service(candidate_satellite)
