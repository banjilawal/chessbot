...
from report.promote.report import PromotionPermissionReport
...
class PawnPromotionAnalyzer(Analyzer):
    ...
    def analyze(
    ...
    ) -> AnalysisResult[PromotionPermissionReport]:
        """
        ...
        if activity_report.token_is_not_free:
            return AnalysisResult.completed(
                PromotionPermissionReport.deny_promotion(
                    PromoteInactivePawnException(
                        cls_mthd=method,
                        cls_name=cls.__name__,
        ...
        return AnalysisResult.completed(PromotionPermissionReport.grant_promotion(pawn=pawn))
