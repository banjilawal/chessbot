# src/recurrence/quadrant/northeast/recurrence.py

"""
Module: recurrence.quadrant.northeast.recurrence
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class NortheastQuadrantRecurrence(QuadrantRecurrence[NortheastQuadrant]):
    ...
    def space_mapping_function(self) -> NortheastMapFunction:
        return cast(NortheastMapFunction, super().space_mapping_function)
