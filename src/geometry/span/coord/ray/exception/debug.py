# src/geometry/span/service/exception.debug.py

"""
Module: geometry.span.service.exception.debug
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class ComputedNullRayDebugException(NullException):
    ...
    Responsibilities:
    1.  Indicate that a rsy arithmetic's result had no origin, and no members.
