# src/geometry/span/coord/ray/diagonal/provider/provider.py

"""
Module: geometry.span.coord.ray.diagonal.provider.provider
Author: Banji Lawal
Created: 2026-03-8
version: 1.0.0
"""
...
from math.span import DiagonalRayComputer, DiagonalPlaneFactors
