# src/geometry/span/coord/ray/diagonal/validator.py

"""
Module: geometry.span.coord.ray.diagonal.computer
Author: Banji Lawal
Created: 2026-02-26
version: 1.0.0
"""
...
class DiagonalRayComputer:
    ...
    def compute(
        ...
        cursor_initialization_result = vector_service.builder.execute(
            x=factors.start_x,
        ...
        if cursor_initialization_result.is_failure:
            ...
            return ComputationResult.failure(
                DiagonalRayComputationException(
                    ...
                    mthd_rslt_type=DiagonalRayComputationException.MTHD_RSLT,
        ...
        while cursor != factors.end_vector:
            ...
            # --- Update the cursor. ---#
            cursor_update_result = vector_service.builder.execute(
                x=cursor.x,
