# src/geometry/span/square/ray/validation/exception/debug/null.py

"""
Module: geometry.span.square.ray.validation.exception.debug.null
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class SquareRayMembersNullException(NullException):
    ...
    Responsibilities:
    1.  Indicate that a SquareRay rank was not validated because it's rays
