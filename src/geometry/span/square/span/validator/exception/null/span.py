# src/geometry/span/square/span/validation/exception/null/span.py

"""
Module: geometry.span.square.span.validation.exception.null.span
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class SquareSpanNullException(NullException):
    ...
    Responsibilities:
    1.  Indicate a SquareSpan is null where it should not be.
