...
from geometry.recurrence import AxisRecurrenceRegistry, QuadrantRecurrenceRegistry
from geometry.registry.collection import RecurrenceRegistryCollection
