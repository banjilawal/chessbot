...
from space import VectorTargetingComputer, PawnAttOffsetPattern, PawnBasis

T = TypeVar("T", bound="PawnAttackOffsetPattern")
...
class PawnAttackVectorBasis(ABC, PawnBasis):
    ...
    def __init__(
            self,
            origin: Vector,
            maneuver_vectors: PawnAttOffsetPattern[T],
