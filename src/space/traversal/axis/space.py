...
from space import AxisEndpointFactory, AxisStepper, TraversalPattern, LinearTargetSet, TargetSpanSet
...
class AxisTraversalPattern(TraversalPattern):
    ...
    @classmethod
    def east_axis(cls, origin: Vector) -> AxisTraversalPattern:
        """
    ...
    @classmethod
    def north_axis(cls, origin: Vector) -> AxisTraversalPattern:
        """
        Create an Axis in 1D plane.
    ...
    @classmethod
    def south_axis(cls, origin: Vector) -> AxisTraversalPattern:
        """
        Create an Axis in 1D plane.
    ...
    @classmethod
    def west_axis(cls, origin: Vector) -> AxisTraversalPattern:
        """
        Create an Axis in 1D plane.
