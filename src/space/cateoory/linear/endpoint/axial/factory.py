...
class AxisEndpointFactory:
    ...
    Provides:
        -   east(origin: Vector) -> VectorRegister
        -   north(origin: Vector) -> VectorRegister
        -   west(origin: Vector) -> VectorRegister
        -   south(origin: Vector) -> VectorRegister
