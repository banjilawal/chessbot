# src/build/context/player/builder.py

"""
Module: build.context.player.builder
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class PlayerContextBuilder(Builder[PlayerContextBuilder]):
    ...
    Responsibilities:
    1.  Produce PlayerContextBuilder instances whose integrity is guaranteed at creation.
    2.  Manage construction of PlayerContextBuilder instances that can be used safely by the client.
    3.  Ensure params for PlayerContextBuilder creation have met the application's safety contract.
