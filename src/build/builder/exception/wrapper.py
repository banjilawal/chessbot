# src/logic/player/build/exception/validator.py
...
class PlayerBuildException(BuildException):
    ...
    Responsibilities:
    1.  Indicate the PlayerBuilder did not produce a valid work product.
    2.  Identify the PlayerBuilder method where the failure occurred.
