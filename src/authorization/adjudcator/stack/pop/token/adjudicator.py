# src/authorization/adjudicator/stack/pop/token/adjudicator.py

"""
Module: authorization.adjudicator.stack.pop.token.adjudicator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class TokenPopRequestAdjudicator(PopRequestAdjudicator):
    ...
    def execute(self, candidate: Any,) -> ValidationResult:
        ...
        Raises:
            TokenStackPopAdjudicatorException
        """
        ...
        if bootstrap.is_failure:
            ...
            return ValidationResult.failure(
                TokenPopRequestAdjudicatorException(
                    cls_mthd=method,
                    cls_name=self.__class__.__name__,
                    msg=TokenPopRequestAdjudicatorException.MSG,
                    err_code=TokenPopRequestAdjudicatorException.ERR_CODE,
