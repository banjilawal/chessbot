# src/authorization/adjudicator/request/promotion/token/adjudicator.py

"""
Module: authorization.adjudicator.request.promotion.token.adjudicator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class PromotionRequestAdjudicator(RequestAdjudicator[PromotionRequest]):
    ...
    def execute(self, candidate: Any,) -> PromotionApprovalReport:
        """
        ...
        if bootstrap.is_failure:
            ...
            return PromotionApprovalReport.deny(
                PromotionRequestAdjudicatorException(
                    cls_mthd=method,
        ...
        return PromotionApprovalReport.approve(pawn=pawn, rank_level=rank)