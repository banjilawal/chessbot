# src/authorization/request/chain/node/search/request.py

"""
Module: authorization.request.chain.node.search.request
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class SearchNodeRequest(ChainNodeRequest, ABC, Generic[T]):
    """
    Role:
        -  Request

    Responsibilities:
        1. Carry Node information for searching a Node to a Chain.
