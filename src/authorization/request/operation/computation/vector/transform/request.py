# src/authorization/request/operation/computation.vector/transform/request.py

"""
Module: authorization.request.operation.computation.vector.transform.request
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
