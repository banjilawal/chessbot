# src/logic/node/context/service/exception/anchor.py

"""
Module: logic.node.context.service.exception.anchor
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class NodeContextServiceException(ServiceException):
    ...
    Responsibilities:
    1.  Anchors NodeQueryService debug (layer-2) error state firing incident
        reports on
