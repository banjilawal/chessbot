# src/authorization/utility/crud/delete/utility.py

"""
Module: authorization.utility.crud.delete.utility
Author: Banji Lawal
Created: 2026-03-30
version: 0.0.2
"""
...
from domain import DeleteContext, DeleteRequest

T = TypeVar("T", bound="DeleteContext")
