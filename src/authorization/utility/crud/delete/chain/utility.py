# src/authorization/utility/crud/delete/chain/utility.py

"""
Module: authorization.utility.crud.delete.chain.utility
Author: Banji Lawal
Created: 2026-03-30
version: 0.0.2
"""
...
from domain import ChainDeleteContext

T = TypeVar("T", bound="ChainDeleteContext")


@dataclass
class ChainDeletePermissionUtility(
    DeletePermissionUtility[T], ABC, Generic[T]
):
    """
    Role:
        -   Utility
