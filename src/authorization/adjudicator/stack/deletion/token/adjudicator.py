# src/authorization/adjudicator/stack/deletion/token/adjudicator.py

"""
Module: authorization.adjudicator.stack.deletion.token.adjudicator
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class TokenDeletionRequestAdjudicator(DeletionRequestAdjudicator):
    ...
    def execute(self, candidate: Any,) -> ValidationResult:
        ...
        Raises:
            TokenStackDeletionAdjudicatorException
        ...
        if bootstrap.is_failure:
            ...
            return ValidationResult.failure(
                TokenDeletionRequestAdjudicatorException(
                    cls_mthd=method,
                    cls_name=self.__class__.__name__,
                    msg=TokenDeletionRequestAdjudicatorException.MSG,
                    err_code=TokenDeletionRequestAdjudicatorException.ERR_CODE,
