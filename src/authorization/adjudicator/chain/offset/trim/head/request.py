# src/authorization/adjudicator/chain/offset/trim/head/request.py

"""
Module: authorization.adjudicator.chain.offset.trim.head.request
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class TrimHeadByOffsetRequest(ChainOffsetRequest):
    """
    Role:
        -  Request
        -  Data Transport
