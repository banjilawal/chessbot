# src/authorization/adjudicator/chain/node/trim/tail/request.py

"""
Module: authorization.adjudicator.chain.node.trim.tail.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class TrimTailByNodeRequest(ChainTrimByNodeRequest, ABC, Generic[T]):
    """
    Role:
        - Request
