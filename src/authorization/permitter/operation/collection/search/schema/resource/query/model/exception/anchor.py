# src/logic/schema/database/operation/collection/search/schema/model/exception/anchor.py

"""
Module: logic.schema.database.searcher.schema.model.exception.anchor
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
