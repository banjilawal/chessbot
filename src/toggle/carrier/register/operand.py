# src/toggle/carrier/register/operand.py

"""
Module: toggle.carrier.register.operand
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class RegisterCarrier(EntityCarrier[Register]):
    """
    Role:
        -   Addressing
        -   Data-Holder
    ...
    Responsibilities:
        1.  Entity for transporting either a Register or RegisterBlueprint
    ...
    @property
    def entity(self) -> [Register | RegisterBlueprint]:
