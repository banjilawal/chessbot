...
class BoardBinderRelationAnalyst(RelationAnalyst[Board, TeamBinder]):
    """
    Role:
        - Relation Analyst
        - Report Generator
    ...
    def analyze(
            cls,
            candidate_primary: Board,
            candidate_satellite: TeamBinder,
        ...
        team_binder = cast(TeamBinder, team_binder_validation_result.payload)
