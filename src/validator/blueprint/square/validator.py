...
class SquareBlueprintValidator(BlueprintValidator[Square]):
    ...
    def execute(
        ...
        if blueprint.coord is not None:
            validation_result = toolkit.square_toolkit.coord_validator.run(
        ...
        if blueprint.board is not None:
            validation_result = toolkit.square_toolkit.board_validator.run(
        ...
        if blueprint.occupant is not None:
            validation_result = toolkit.square_toolkit.token_validator.run(
