# src/validator/itinerary/validator.py

"""
Module: validator.itinerary.validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from err import DisabledTokenManeuverException, ItinerarySourceEqualsDestinationException, ItineraryValidatorException
from model import Itinerary
from report import TokenReadinessReport
from result import ValidationResult
from toolkit import ItineraryToolkit
from util import LoggingLevelRouter
from validator import ItineraryConsistencyValidator, Validator


class ItineraryValidator(ModelValidator[Itinerary]):
    """
    Role
        -   Transaction Worker
    ...
    def execute(
        ...
        consistency_validation_result = consistency_validator.execute(
            itinerary=itinerary,
            toolkit=toolkit,
        )
