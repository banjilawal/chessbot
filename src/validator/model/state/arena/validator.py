# src/validator/model/state/arena/validator.py

"""
Module: validator.model.state.arena.operation
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from core.certifier import ArenaRootCertifier
...
class ArenaValidator(ModelValidator[Arena]):
    ...
    Attributes:
        root_certifier: ArenaRootCertifier
    ...
    def __init__(
            self,
            root_certifier: ArenaRootCertifier | None = ArenaRootCertifier(),
    ):
