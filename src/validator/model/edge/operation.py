# src/validator/edge/validator.py

"""
Module: validator.edge.validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class EdgeValidator(ModelValidator[Edge]):
    ...
    def validate(
        ...
        distance_validation_result = number_validator.build(
        ...
        head_validation_result = node_validator.build(edge.head)
        ...
        tail_validation_result = node_validator.build(edge.head)
