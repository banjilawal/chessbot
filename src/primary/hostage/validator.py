# src/certifier/hostage/validator.py

"""
Module: certifier.hostage.validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class HostageRootCertifier(RootCertifier[Hostage]):
    """
    ...
    def validate(
        ...
        """
        method = "HostageCertifier.execute"
        ...
        if candidate is None:
            ...
            return ValidationResult.failure(
                HostageCertifierException(
                    msg=f"{method}: {HostageCertifierException.MSG}",
