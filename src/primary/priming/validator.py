# src/certifier/priming/validator.py

"""
Module: certifier.priming.validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from validator import Certifier, PrimingValidator
from err import (
    BlueprintNullException, CertifierException, ExcessBlueprintFlagsException, ZeroBlueprintFlagsException
)


class BlueprintPrimingValidator(RootCertifier[Blueprint]):
    """
    Role
        -   Transaction Worker
        ...
        if validator_priming_result.is_failure:
            ...
            return ValidationResult.failure(
                CertifierException(
                    ...
                    msg=CertifierException.MSG,
                    err_code=CertifierException.ERR_CODE,
