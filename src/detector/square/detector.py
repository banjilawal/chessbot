...
class SquareCollisionDetector(Detector[Square]):
    ...
    def execute(
        ...
        validation_result = stream.microservice.validator.validate(target)
        ...
        return AnalysisResult.completed(CollisionReport.no_collisions(target))
