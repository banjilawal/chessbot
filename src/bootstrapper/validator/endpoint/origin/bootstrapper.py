# src/carrier_validator/validator/endpoint/origin/carrier_validator.py

"""
Module: carrier_validator.validator.endpoint.origin.carrier_validator
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
        ...
        if relation_analysis_result.is_failure:
            ...
            return ValidationResult.failure(
                OriginCertifierBootstrapperException(
                    ...
                    msg=OriginCertifierBootstrapperException.MSG,
                    err_code=OriginCertifierBootstrapperException.ERR_CODE,
