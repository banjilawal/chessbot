# src/carrier_validator/assembly/board/operation.py

"""
Module: carrier_validator.assembly.board.operation
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class BoardAssemblyPrimer(AssemblyPrimer[Board]):
    """
    Role
        -   Transaction Worker
        ...
        if blueprint_validation_result.is_failure:
            ...
            return ValidationResult.failure(
                PrimingBoardAssemblyException(
                    ...
                    msg=PrimingBoardAssemblyException.MSG,
                    err_code=PrimingBoardAssemblyException.ERR_CODE,
...
WorkerRegistryController.register_worker(worker=BoardAssemblyPrimer)
