# src/bootstrapper/assembly/path/operation.py

"""
Module: bootstrapper.assembly.path.operation
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from operation.collection.searcher import SquareNotFoundException
...
class PathAssemblyPrimer(AssemblyPrimer[Path]):
    ...
    def _run_validations(
        ...
        formation_validation = toolkit.formation_service.execute.execute(
