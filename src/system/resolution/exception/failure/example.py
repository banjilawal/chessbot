...
"""
Module: logic.system.old_search.rollback_exception
Author: Banji Lawal
Created: 2025-10-04
version: 1.0.0
...
# SECTION 2 - Scope:
The module's effects and actions cover exception raised by implementors of the `SearchRouter` interface.
