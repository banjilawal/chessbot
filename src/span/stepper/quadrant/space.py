# src/span/stepper/quadrant/span.py

"""
Module: span.stepper.quadrant.span
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from err.span.setter.quadrant.exception import QuadrantSpanSetterException
from model import Vector
from register import NumberRegister
from result import ComputationResult, MethodResultType
from span import KnightSpan, SpanStepper
from util import LoggingLevelRouter


class QuadrantStepper(SpanStepper[KnightSpan]):
    """
    Role:
        -   Computation Worker
        ...
        if build.is_failure:
            ...
            return ComputationResult.failure(
                QuadrantSpanSetterException(
                    ...
                    msg=QuadrantSpanSetterException.MSG,
                    err_code=QuadrantSpanSetterException.ERR_CODE,
