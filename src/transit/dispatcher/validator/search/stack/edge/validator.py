# src/transit/dispatcher/validator/search/stack/edge/validator.py

"""
Module: transit.dispatcher.validator.search.stack.edge.validator
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class EdgeContextValidator(ContextValidator[Edge]):
    ...
    def validate(
        ...
        """
        method = "EdgeContextValidator.execute"
        ...
        if candidate is None:
            ...
            return ValidationResult.failure(
                EdgeContextValidatorException(
                    msg=f"{method}: {EdgeContextValidatorException.MSG}",
