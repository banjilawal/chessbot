# src/transit/dispatcher/builder/space/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.space.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class SpaceBuilder(Builder, Generic[T]):
    ...
    def builder_toolkit(self) -> SpaceBuilderToolkit:
        return cast(SpaceBuilderToolkit, super().assembler)
