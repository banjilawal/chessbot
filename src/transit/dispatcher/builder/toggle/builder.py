# src/transit/dispatcher/builder/dispatcher/builder/toggle/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.toggle.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class ToggleBuilder(Builder, Generic[T]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> BuilderToolkit[T]:
        return cast(ToggleBuilderToolkit[T], super().assembler)
