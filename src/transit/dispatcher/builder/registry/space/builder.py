# src/transit/dispatcher/builder/registry/space/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.registry.space.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class SpaceReservoirBuildDispatcher(BuildDispatcher, Generic[T]):
    ...
    def builder_toolkit(self) -> SpaceReservoirBuilderToolkit:
        return cast(SpaceReservoirBuilderToolkit, super().assembler)
