# src/transit/dispatcher/builder/registry/space/axis/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.registry.space.axis.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class AxisReservoirBuilder(SpaceReservoirBuilder[AxisReservoir]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> AxisReservoirBuilderToolkit:
        return cast(AxisReservoirBuilderToolkit, super().assembler)
