# src/transit/dispatcher/builder/context/linegeo/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.context.linegeo.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
   ...
   Responsibilities:
    ...
    def build(
        ...
        if coord is not None:
            build_result = toolkit.coord_service.execute.execute(coord)
