# src/transit/dispatcher/builder/context/hostage/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.context.hostage.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
   ...
   Responsibilities:
    ...
    def build(
        ...
        if captured_square is not None:
            validation = square_service.execute.execute(candidate=captured_square)
            if validation.is_failure:
                # Send the exception chain on failure.
                return BuildResult.failure(
                    HostageContextBuilderException(
