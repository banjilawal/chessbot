# src/transit/dispatcher/builder/register/vector/dispatcher/builder.py
...
class VectorRegisterBuilder(RegisterBuildDispatcher[VectorRegister]):
   ...
   Responsibilities:
    ...
    def __init__(self, builder_toolkit: VectorRegisterBuilderToolkit | 
    ...
    def builder_toolkit(self) -> VectorRegisterBuilderToolkit:
        return cast(VectorRegisterBuilderToolkit, super().assembler)
