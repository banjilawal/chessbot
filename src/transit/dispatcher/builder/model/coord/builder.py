# src/transit/dispatcher/builder/model/coord/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.coord.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class CoordBuilder(ModelBuilder[Coord]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> CoordBuilderToolkit:
        return cast(CoordBuilderToolkit, super().assembler)
