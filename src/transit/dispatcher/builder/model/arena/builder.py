# src/transit/dispatcher/builder/model/arena/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.arena.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class ArenaBuilder(ModelBuilder[Arena]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> ArenaBuilderToolkit:
        return cast(ArenaBuilderToolkit, super().assembler)
