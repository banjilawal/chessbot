# src/transit/dispatcher/builder/model/edge/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.edge.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class EdgeBuilder(ModelBuilder[Edge]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> EdgeBuilderToolkit:
        return cast(EdgeBuilderToolkit, super().assembler)
