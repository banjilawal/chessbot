# src/transit/dispatcher/builder/model/square/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.square.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from operation.toolkit import SquareBuilderToolkit
...
class SquareBuilder(ModelBuilder[Square]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> SquareBuilderToolkit:
        return cast(SquareBuilderToolkit, super().assembler)
