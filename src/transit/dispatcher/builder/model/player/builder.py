# src/transit/dispatcher/builder/model/player/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.player.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.metadata.blueprint import PlayerBlueprint
...
class PlayerBuilder(ModelBuilder[Player]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> PlayerBuilderToolkit:
        return cast(PlayerBuilderToolkit, super().assembler)
