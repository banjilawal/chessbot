# src/transit/dispatcher/builder/model/structure/node/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.node.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from operation.toolkit import NodeBuilderToolkit
...
class NodeBuilder(ModelBuilder[Node]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> NodeBuilderToolkit:
        return cast(NodeBuilderToolkit, super().assembler)
