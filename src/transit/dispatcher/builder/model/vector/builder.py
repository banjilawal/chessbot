# src/transit/dispatcher/builder/model/vector/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.vector.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class VectorBuilder(ModelBuilder[Vector]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> VectorBuilderToolkit:
        return cast(VectorBuilderToolkit, super().assembler)
