# src/transit/dispatcher/builder/model/snapshot/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.snapshot.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class SnapshotBuilder(ModelBuilder[Snapshot]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> SnapshotBuilderToolkit:
        return cast(SnapshotBuilderToolkit, super().assembler)
