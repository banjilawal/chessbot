# src/transit/dispatcher/builder/model/game/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.game.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class GameBuilder(ModelBuilder[Game]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> GameBuilderToolkit:
        return cast(GameBuilderToolkit, super().assembler)
