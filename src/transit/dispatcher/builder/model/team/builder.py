# src/transit/dispatcher/builder/model/team/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.team.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class TeamBuilder(ModelBuilder[Team]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> TeamBuilderToolkit:
        return cast(TeamBuilderToolkit, super().assembler)
