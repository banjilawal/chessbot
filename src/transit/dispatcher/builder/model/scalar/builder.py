# src/transit/dispatcher/builder/model/scalar/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.scalar.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class ScalarBuilder(ModelBuilder[Scalar]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> ScalarBuilderToolkit:
        return cast(ScalarBuilderToolkit, super().assembler)
