# src/transit/dispatcher/builder/model/rank/dispatcher/builder.py

"""
Module: transit.dispatcher.builder.model.rank.builder
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class RankBuilder(ModelBuilder[Rank]):
   ...
   Responsibilities:
    ...
    def builder_toolkit(self) -> RankBuilderToolkit:
        return cast(RankBuilderToolkit, super().assembler)
