# src/logic/player/context/transit/route/exception/debug/exist.py

"""
Module: logic.player.context.route.exception.debug.exist
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class PlayerNotFoundException(PlayerDebugException):
    ...
    """
    ERR_CODE = "PLAYER_NOT_FOUND_EXCEPTION"
    MSG = "No player matching the attribute was found."
