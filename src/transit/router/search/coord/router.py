# src/logic/context/coord/transit/route/transit/router.py
...
class CoordSearchRouter(StackSearchRouter[Coord]):
    ...
    def _find_by_row( cls, dataset: List[Coord], row: int ) -> SearchResult[List[Coord]]:
        ...
        Raises:
            None
        """
        method = "CoordSearchRouter._find_by_row"
    ...
    def _find_by_column(cls, dataset: List[Coord], column: int) -> SearchResult[List[Coord]]:
        ...
        Raises:
            None
        """
        method = "CoordSearchRouter._find_by_column"
    ...
    def _find_by_row_and_column(cls, dataset: List[Coord], row:int, column: int) -> SearchResult[List[Coord]]:
        ...
        Raises:
            None
        """
        method = "CoordSearchRouter._find_by_row_and_column"
