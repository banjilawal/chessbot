# src/transit/logic/square/database/kernel/operation/roster/exception.py
...
from domain.model.collectable.state import Token, TokenContext, TokenNotFoundException
