# src/transit/controller/registry/worker/controller.py

"""
Module: transit.controller.registry.worker.controller
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from artifcat import InsertionResult, SearchResult
...
class WorkerRegistryController(Controller[WorkerRegistry]):
    ...
    @LoggingLevelRouter.monitor
    def find_worker(self, domain: str, operation_name: str,) -> SearchResult[List[Operator]]:
        """
    ...
    @LoggingLevelRouter.monitor
    def domain_workers(self, domain: str,) -> SearchResult[List[Dict[str, Operator]]]:
        """
