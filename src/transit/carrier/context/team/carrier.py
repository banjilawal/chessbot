# src/transit/carrier/team/carrier.py

"""
Module: transit.carrier.team.carrier
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from transit.model import Team
...
class TeamCarrier(ModelCarrier):
    ...
    Responsibilities:
        1.  Transport a hydrated Team or its Blueprint across validation and other
