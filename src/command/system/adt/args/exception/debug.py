# src/command/service/adt/args/exception/debug.py

"""
Module: command.service.adt.args.exception.debug
Author: Banji Lawal
Created: 2026-02-24
version: 1.0.0
"""
...
class CommandArgsDebugException(DebugException):
    ...
    Responsibilities:
        1.  Carry metadata about the variable that fired a CommandArgs instance into its  error state.
