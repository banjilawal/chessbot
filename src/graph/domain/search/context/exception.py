# src/logic/points/searcher/collision.py
...
class InvalidResidentSearchContextException(ResidentSearchContextException, ValidatorException):
    """
...
class ArenaResidentSearchParamsException(ResidentSearchContextException):
    """
