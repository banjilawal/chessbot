# src/kit/toolkit/context/linegeo/toolkit.py

"""
Module: kit.toolkit.context.linegeo.toolkit
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from kit.toolkit import VectorContextToolkit
   ...
   Responsibilities:
    ...
    def __init__(
        ...
        if coord is not None:
            toolkit_result = kit.toolkit.coord_service.execute.execute(coord)
        ...
        toolkit_result = kit.toolkit.vector_service.execute.execute(vector)
        if toolkit_result.is_failure:
            # Send the exception chain on failure.
            return ToolkitResult.failure(
                VectorContextToolkitException(
