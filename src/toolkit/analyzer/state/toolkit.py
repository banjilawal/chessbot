# src/toolkit/analyzer/state/toolkit.py

"""
Module: toolkit.analyzer.state.toolkit
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class StateAnalyzerToolkit(AnalyzerToolkit[StateAnalyzer]):
    """
    Role:
    ...
    Responsibilities:
        1.  Aggregates workers and services a stateful analyzer requires for its tasks.
