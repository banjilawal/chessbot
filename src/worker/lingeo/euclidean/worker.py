# src/worker/lingeo/euclidean/worker.py

"""
Module: worker.lingeo.euclidean.worker
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from err import LinGeoContextMismatchException
        ...
        if not isinstance(u, type(v)):
            ...
            return ComputationResult.failure(
                LinGeoEuclideanException(
                    ...
                    msg=LinGeoEuclideanException.MSG,
                    err_code=LinGeoEuclideanException.ERR_CODE,
                    ex=LinGeoContextMismatchException(
                        msg=LinGeoEuclideanException.MSG,
                        err_code=LinGeoEuclideanException.ERR_CODE,
                    )
                )
