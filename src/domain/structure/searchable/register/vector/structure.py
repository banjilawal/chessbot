# src/domain/structure/searchable/register/vector/structure.py

"""
Module: domain.structure.searchable.register.vector.structure
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import Register, Vector
