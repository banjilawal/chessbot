# src/domain/structure/searchable/register/coord/structure.py

"""
Module: domain.structure.searchable.register.coord.register
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import Coord, Register
