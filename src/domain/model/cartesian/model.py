# src/domain/model/cartesian/model.py

"""
Module: domain.model.cartesian.model
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class CartesianPoint(DataModelObject):
    """
    Role:
        -   Model
    ...
    About:
        Consider,
            ...
            6.  We see iterating through a series of Coords requires the cartesian;
                    V(delta_x, delta_y).
            7.  Therefore, a Cartesian provides the interval for stepping through
                a series of Coords.
    ...
    def __str__(self):
        return f"Cartesian:{{x:{self._x}, y:{self._y}}}"
