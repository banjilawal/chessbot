# src/domain/model/state/arena/dossier/model.py

"""
Module: domain.model.state.arena.model
Author: Banji Lawal
Created: 2025-02-08
version: 1.0.0
"""
...
from domain.model import ArenaBinder, StateDataModelObject


class Arena(StateDataModelObject):
    _id: int
