# src/dossier/model/state/team/roster/exception/super.py

"""
Module: domain.model.state.team.roster.exception.super
Author: Banji Lawal
Created: 2025-10-06
version: 1.0.0
"""
...
from domain.model.state.team import TeamException
