# src/dossier/model/state/team/roster/util/util.py

"""
Module: domain.model.state.team.roster.util.util
Author: Banji Lawal
Created: 2026-02-22
version: 1.0.0
"""
...
from domain.model.rank import RankService
from domain.model import FormationKey, FormationService
from system import IdFactory, IdentityService, UpdateResult
from domain.model.state.team import FillingTeamRosterException, RosterRelationAnalysis, Team, TeamValidator
...
class RosterUtil:
    ...
    def fill_team_roster(
        ...
        for formation in formation_lookup_result.payload:
            ...
            # Build the token.
            token_build_result = team.roster.service.builder.execute(
                owner=team,
