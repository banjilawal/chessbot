# src/domain/model/state/team/dossier/model/state.py

"""
Module: domain.model.collectable.state.team.model
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.model import Board, Player, StatefulModel, TeamState
