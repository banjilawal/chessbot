# src/domain/model/state/team/roster/exception/insertion/__init__.py

"""
Module: domain.model.collectable.state.team.roster.exception.insertion.__init__
Author: Banji Lawal
Created: 2025-10-06
version: 1.0.0
"""

# =========== DOMAIN.MODEL.COLLECTABLE.STATE.TEAM.ROSTER.EXCEPTION.INSERTION PACKAGE ===========#
