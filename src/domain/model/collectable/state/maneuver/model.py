# src/domain/model/collectable/state/model/state/maneuver.py

"""
Module: domain.model.collectable.state.model.maneuver
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.model import ManeuverState, Path, StatefulModel
