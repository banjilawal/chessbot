# src/domain/model/searchable/state/team/roster/exception/insertion/different.py

"""
Module: domain.model.searchable.state.team.roster.exception.insertion.different
Author: Banji Lawal
Created: 2025-10-06
version: 1.0.0
"""
