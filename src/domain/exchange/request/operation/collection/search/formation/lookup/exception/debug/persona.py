...
from domain.exchange.model import FormationException
...
class FormationPersonaBoundsException(FormationException, BoundsException):
    ...
    Responsibilities:
    1.  Indicate a Formation lookup failed because the persona value was not permitted for the Formation
        attribute.
