# src/logic/hostage/context/route/exception/debug/exist.py

"""
Module: logic.hostage.context.route.exception.debug.exist
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
from domain.exchange.model import HostageDebugException


# ======================# HOSTAGE_NOT_FOUND_EXCEPTION #======================#
class HostageNotFoundException(HostageDebugException):
    """
