...
from domain.exchange.model import GameFinder
from system import QueryService, id_emitter
from domain.exchange.model import GameContext, GameContextBuilder, GameContextValidator
...
class GameQueryService(QueryService[GameContext]):
    ...
    def __init__(
        ...
        # PARAMETERS:
            ...
            *   validation (GameContextValidator): Default value - GameContextValidator()
    ...
    @property
    def validation(self) -> GameContextValidator:
