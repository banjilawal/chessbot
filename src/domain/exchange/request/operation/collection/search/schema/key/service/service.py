...
from domain.exchange.model import SchemaLookupProcess, SchemaKey, SchemaKeyBuilder, SchemaKeyValidator
...
class SchemaKeyService(QueryService[SchemaKey]):
    ...
    def __init__(
        ...
        # PARAMETERS:
            ...
            *   validation (SchemaContextValidator)
        # RETURNS:
            None
        Raises:
            None
