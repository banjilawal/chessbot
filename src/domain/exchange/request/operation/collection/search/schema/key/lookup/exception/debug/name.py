...
from domain.exchange.model import SchemaException
...
class SchemaNameBoundsException(SchemaException, BoundsException):
    ...
    Responsibilities:
    1.  Indicate a Schema lookup failed because the schema was not a key to any Schema variant.
    ...
    MSG = "SchemaLookupProcess failed: No schema items use the target as their key."
