...
from operation.microservice.token.attack import AttackDebugException
...
class AttackerSquareInconsistencyException(AttackDebugException):
    ...
    Responsibilities:
    1.  Indicate an attack failed because the attacker's item does not have them as an occupant.
