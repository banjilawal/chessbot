# src/domain/exchange/request/validation/model/board/request.py

"""
Module: domain.exchange.request.validation.model.board.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import ModelValidationRequest, Board
