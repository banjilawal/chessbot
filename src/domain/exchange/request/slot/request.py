# src/domain/exchange/request/slot/request.py

"""
Module: domain.exchange.request.slot.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.exchange.model import Rank
from domain.exchange.request.slot.request import Request
