# src/domain/exchange/request/microservice/token/promotion/request.py

"""
Module: domain.exchange.request.microservice.token.promotion.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.exchange.model import PawnToken, Rank
