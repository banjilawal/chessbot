# src/domain/exchange/request/microservice/request.py

"""
Module: domain.exchange.request.microservice.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, MicroserviceRequest):
            ...
            return (
                    ...
                    self._microservice.id == domain.exchange.request.microservice.id
            )
        return False