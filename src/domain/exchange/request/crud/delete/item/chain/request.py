# src/domain/exchange/request/crud/delete/item/chain/request.py

"""
Module: domain.exchange.request.crud.delete.item.chain.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import DeleteItemRequest, Node
...
class RemoveNodeRequest(DeleteItemRequest, ABC, Generic[T]):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, RemoveNodeRequest):
            request = cast(RemoveNodeRequest, other)
