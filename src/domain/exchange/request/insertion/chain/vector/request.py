# src/domain/exchange/request/insertion/chain/request.py

"""
Module: domain.exchange.request.insertion.chain.request
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class AddVectorNodeRequest(AddNodeRequest[VectorNode]):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, AddVectorNodeRequest):
            ...
            return self._id == domain.exchange.request.id
        return False