# src/domain/metadata/unions/model/searchable/state/arena/manifest.py

"""
Module: domain.metadata.unions.model.searchable.state.arena.manifest
Author: Banji Lawal
Created: 2026-03-30
version: 0.0.2
"""
...
class ArenaTypeUnions(ModelTypeUnions[Arena]):
    ...
    Attributes:
        ...
        search_context: Type[ArenaContext] = ArenaContext
