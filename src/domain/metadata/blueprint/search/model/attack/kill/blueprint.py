# src/domain/metadata/blueprint/search/model/attack/kill/blueprint.py

"""
Module: domain.metadata.blueprint.search.model.attack.kill.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import KillSearchContext, Board, Game, SearchContextBlueprint, Player
from err import KillSearchContextNullException


class KillContextBlueprint(SearchContextBlueprint[KillSearchContext]):
    """
     Role:
        1.  Metadata

     Responsibilities:
         1.  Provide attributes for hydrating an KillSearchContext.
    ...
    @property
    def domain_class(self) -> Type[KillSearchContext]:
