...
from domain import VectorSearchContext, Board, Game, SearchContextBlueprint, Player
from err import VectorSearchContextNullException


class VectorContextBlueprint(SearchContextBlueprint[VectorSearchContext]):
    """
     Role:
        1.  Metadata
