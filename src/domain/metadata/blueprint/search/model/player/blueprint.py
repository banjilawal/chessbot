...
from domain import PlayerSearchContext, Board, Game, SearchContextBlueprint, Player
from err import PlayerSearchContextNullException


class PlayerContextBlueprint(SearchContextBlueprint[PlayerSearchContext]):
    """
     Role:
        1.  Metadata
