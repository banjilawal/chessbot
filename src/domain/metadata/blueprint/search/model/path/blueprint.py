...
from domain import PathSearchContext, Board, Game, SearchContextBlueprint, Player
from err import PathSearchContextNullException


class PathContextBlueprint(SearchContextBlueprint[PathSearchContext]):
    """
     Role:
        1.  Metadata

     Responsibilities:
         1.  Provide attributes for hydrating an PathSearchContext.
    ...
    @property
    def domain_class(self) -> Type[PathSearchContext]:
