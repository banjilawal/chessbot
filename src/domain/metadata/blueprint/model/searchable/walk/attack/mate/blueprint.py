...
from domain import AttackBlueprint, KingToken, Maneuver, MateEnemyKing, Token
...
class MateEnemyBlueprint(AttackBlueprint):
    ...
    def __init__(
            ...
            maneuver: Maneuver,
            mated_king: KingToken,
            domain_class: Optional[Type[MateEnemyKing]] | None = None,
        ...
        super().__init__(
            ...
            domain_class=domain_class or MateEnemyKing,
    ...
    @property
    def domain_class(self) -> Type[MateEnemyKing]:
        return cast(Type[MateEnemyKing], super().domain_class)
