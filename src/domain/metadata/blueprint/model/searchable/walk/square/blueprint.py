# src/domain/metadata/blueprint/model/searchable/walk/square/blueprint.py

"""
Module: domain.metadata.blueprint.model.searchable.walk.square.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import Board, Coord, Formation, Square, SquareSearchContext, WalkModelBlueprint
from err import SquareNullException


class SquareBlueprint(WalkModelBlueprint[Square]):
    """
     Role:
        1.  Metadata
