# src/domain/metadata/blueprint/model/searchable/walk/team/blueprint.py

"""
Module: domain.metadata.blueprint.model.searchable.walk.team.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import Archetype, Board, Player, WalkModelBlueprint, Team, TeamSearchContext
from err import TeamNullException


class TeamBlueprint(WalkModelBlueprint[Team]):
    """
     Role:
        1.  Metadata
