# src/domain/metadata/blueprint/model/searchable/walk/arena/blueprint.py

"""
Module: domain.metadata.blueprint.model.searchable.walk.arena.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain import Arena, ArenaPlayerColorBinder, ArenaSearchContext, Board, WalkModelBlueprint
from err import ArenaNullException


class ArenaBlueprint(WalkModelBlueprint[Arena]):
    """
     Role:
        1.  Metadata
