# src/domain/metadata/blueprint/validation/edge/blueprint.py

"""
Module: domain.metadata.blueprint.validation.query.edge.blueprint
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.model import Edge, Blueprint, Node
