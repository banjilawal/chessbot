# src/assurance/checker/search/chain/square/checker.py

"""
Module: assurance.checker.search.chain.square.checker
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from assurance import SquareValidationBundle, ChainContextChecker
...
class SquareContextChecker(ChainContextChecker[SquareSearchContext]):
    """
    Role
