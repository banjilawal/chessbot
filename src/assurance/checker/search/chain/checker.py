# src/assurance/checker/search/chain/checker.py

"""
Module: assurance.checker.search.chain.checker
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class ChainContextChecker(SearchContextChecker[T], ABC, Generic[T]):
    """
    Role
