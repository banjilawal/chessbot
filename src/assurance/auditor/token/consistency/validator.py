# src/assurance/auditor/token/assurance/auditor/assurance/auditor.py

"""
Module: assurance.auditor.token.consistency.consistency
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class TokenConsistencyConsistencyAuditor(ConsistencyAuditor[Token]):
    ...
    def verify_token_is_king(cls, candidate: Any) -> ValidationResult[KingToken]:
        ...
        if validation.is_failure:
            ...
            return ValidationResult.failure(
                TokenAuditorException(
                    msg=f"{method}: {TokenAuditorException.MSG}",
