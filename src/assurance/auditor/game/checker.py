# src/assurance/auditor/game/assurance/auditor.py

"""
Module: assurance.auditor.game.consistency
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class GameConsistencyChecker(ConsistencyChecker[Game]):
    """
    ...
    None
    """
    OPERATION_NAME = "game_consistency"
    ...
    def validate(
        ...
        Validates team_name game meets graph requirements:
          ...
          - valid visitor_id
          - valid visitor_name
          - Game.team_history meets coord_stack_consistency requirements
