# src/assurance/validator/model/state/player/validator.py

"""
Module: assurance.validator.model.state.player.operation
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
class PlayerValidator(ModelValidator[Player]):
    ...
    @property
    def integrity_checker(self) -> PlayerRootCertifier:
        return cast(PlayerRootCertifier, self.integrity_checker)
