# src/logic/token/database/operation/collection/search/context/service/operation/validation/exception/__init__.py
...
# =========== OPERATION.COLLECTION.SEARCH.TOKEN.DATABASE.SEARCHER.QUERY.SERVICE.OPERATION.VALIDATION.EXCEPTION PACKAGE ===========#
