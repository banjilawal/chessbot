# src/operation/toolkit/analyzer/hostage/toolkit.py

"""
Module: operation.toolkit.analyzer.hostage.toolkit
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from sensor.analyzer import Hostage
from operation.toolkit.analyzer.bootstrapper.hostage.toolkit import AnalyzerBootstrapperToolkit


class HostageToolkit(AnalyzerBootstrapperToolkit[Hostage]):
    """
    Role:
        - Container
