# src/operation/toolkit/model/team/toolkit.py

"""
Module: operation.toolkit.model.team.toolkit
Author: Banji Lawal
Created: 2026-04-03
version: 0.0.2
"""
...
from domain.metadata.blueprint import TeamBlueprint, TokenBlueprint
...
from operation.toolkit.model.state.team.toolkit import StateModelToolkit
...
class TokenToolkit(StateModelToolkit[Token]):
    ...
    home_detector: TokenHomeReporter = TokenHomeReporter()
