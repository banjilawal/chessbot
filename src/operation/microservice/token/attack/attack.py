...
from operation.microservice.token.attack import (
...
from domain.model.searchable.state import CombatantReadinessEnum, KingToken, Token, TokenDeployment, TokenService
...
class Attack:
    ...
    def execute(
        ...
        square_validation = square_database.microservice.execute.execute(candidate=square)
    ...
    def _process_attack(
        ...
        prisoner.deployment = TokenDeployment.REMOVED_FROM_BOARD
