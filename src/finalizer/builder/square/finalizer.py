# src/finalizer/builder/square/finalizer.py

"""
Module: finalizer.builder.square.finalizer
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
WorkerRegistryController.register_worker(worker=SquareBuilderFinalizer)