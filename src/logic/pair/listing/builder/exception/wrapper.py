...
class PairListBuildException(BuildException):
    ...
    Responsibilities:
    1.  Indicate the PairListBuildTransaction did not produce a valid work product.
    2.  Identify the PairListBuildTransaction method where the failure occurred.
    ...
    MSG = "Failure in PairListBuildTransaction method."
