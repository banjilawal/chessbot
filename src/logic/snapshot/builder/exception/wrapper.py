...
class SnapshotBuildException(BuildException):
    ...
    Responsibilities:
    1.  Indicate the SnapshotBuildProcess did not produce a valid work product.
    2.  Identify the SnapshotBuildProcess method where the failure occurred.
    ...
    MSG = "Failure in SnapshotBuildProcess method."
