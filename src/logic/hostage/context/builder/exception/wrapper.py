# src/logic/hostage/context/builder/exception/wrapper.py

"""
Module: logic.hostage.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
__all__ = [
    # ======================# HOSTAGE_CONTEXT_CONTEXT_BUILD_FAILURE #======================#
...
class HostageContextBuildException(BuildException):
    ...
    ERR_CODE = "HOSTAGE_CONTEXT_CONTEXT_BUILD_FAILURE"
