# src/logic/hostage/validation/exception/flag/zero.py

"""
Module: logic.hostage.validation.exception.flag.zero
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# ZERO_HOSTAGE_CONTEXT_FLAGS_EXCEPTION #======================#
class ZeroHostageContextFlagsException(DebugException):
    """
    ...
    2.  A failing ValidationResult was returned because HostageContext candidate had no context flags enabled.
