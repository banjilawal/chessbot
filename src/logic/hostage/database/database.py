# src/logic/hostage/database/transaction.py
...
class HostageDatabase(Database[Hostage]):
    ...
    def add_unique(self, manifest: Hostage) -> InsertionResult[Hostage]:
        ...
        validation = self.integrity_service.validation.execute(candidate=manifest)
        ...
        # --- CheckSquare if the hostage is already in the collider_candidates before adding it. ---#
