...
class ArenaContextException(AnchorException):
    ...
    # RESPONSIBILITIES:
    1.  Anchoring target for ArenaContext debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which ArenaContext method received a worker's (layer-1) failure result.
