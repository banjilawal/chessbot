# src/logic/arena/context/validator/exception/debug/route.py

"""
Module: logic.arena.context.validator.exception.debug.route
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class ArenaContextValidationRouteException(ArenaContextException, ExecutionRouteException):
    """
