# src/logic/arena/context/validation/exception/debug/null.py

"""
Module: logic.arena.context.validation.exception.debug.null
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# NULL_ARENA_CONTEXT_EXCEPTION #======================#
class NullArenaContextException(NullException):
    """
   ...
   None
    ...
    ERR_CODE = "NULL_ARENA_CONTEXT_EXCEPTION"
