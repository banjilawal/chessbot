# src/logic/arena/service/exception/debug/insertion/duplicate.py

"""
Module: logic.arena.service.exception.debug.insertion.duplicate
Author: Banji Lawal
Created: 2025-10-01
version: 1.0.0
"""
...
class ArenaAlreadyContainsTeamException(ArenaException, DebugException):
    ...
    None
    """
    ERR_CODE = "ARENA_ALREADY_CONTAINS_TEAM_EXCEPTION"
