...
# ======================# GRAPH_CONTEXT_SERVICE_EXCEPTION #======================#
class GraphContextServiceException(ServiceException):
    """
    # ROLE: Coverage Target, Exception Chain Layer 0

    Responsibilities:
    1.  Anchoring target for GraphContextService debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which GraphContextService method received a worker's (layer-1) failure result.
