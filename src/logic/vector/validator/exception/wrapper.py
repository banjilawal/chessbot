# src/logic/vector/validator/exception/wrapper.py
...
class VectorValidationException(ValidationException):
    ...
    Responsibilities:
    1.  Identify the VectorValidationProcess method where the process failed.
   ...
   None
    ...
    MSG = "Failure in VectorValidationProcess method."
    OP = "Validation"
