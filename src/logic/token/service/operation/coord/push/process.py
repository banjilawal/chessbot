...
from logic.token import InactiveTokenPushingCoordException, Token, TokenPositionPushException, TokenValidator
...
class TokenPushCoordProcess:
    ...
    def execute(
        ...
        Raises:
            ...
            TokenPositionPushException
            TokenCoordHandlerException
            InactiveTokenTokenPositionPushException
        ...
        if token_validation_result.is_failure:
            ...
            return InsertionResult.failure(
                TokenPositionPushException(
                    mthd=method,
                    title=cls.__name__,
                    op=TokenPositionPushException.OP,
                    msg=TokenPositionPushException.MSG,
                    err_code=TokenPositionPushException.ERR_CODE,
                    rslt_type=TokenPositionPushException.RSLT_TYPE,
