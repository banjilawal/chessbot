# src/logic/token/service/detector/exception/debug/square.py

"""
Module: logic.token.service.detector.exception.debug.square
Author: Banji Lawal
Created: 2025-11-22
version: 1.0.0
"""
...
class TokenOpeningSquareCollisionException(TokenStackException):
    ...
    None
    """
    ERR_CODE = "TOKEN_OPENING)SQUARE_COLLISION_EXCEPTION"
