# src/logic/token/service/detector/exception/debug/designation.py

"""
Module: logic.token.service.detector.exception.debug.designation
Author: Banji Lawal
Created: 2025-11-22
version: 1.0.0
"""
...
class TokenDesignationCollisionException(TokenStackException):
    ...
    None
    """
    ERR_CODE = "TOKEN_DESIGNATION_COLLISION_EXCEPTION"
