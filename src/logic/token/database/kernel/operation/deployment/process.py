...
from logic.system import DeletionResult, LoggingLevelRouter, UpdateResult
from logic.token import Token, TokenStackService, TokenStackState
from logic.token.database.kernel.operation.deployment import (
        ...
        if token_stack.is_deployed_on_board:
            ...
            return UpdateResult.update_failure(
                ...
                exception=TokenStackDeploymentException(
                    ...
                    rslt_type=TokenStackDeploymentException.RSLT_TYPE,
