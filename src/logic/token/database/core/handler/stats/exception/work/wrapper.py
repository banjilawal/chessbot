# src/logic/token/database/core/handler/stats/exception/work/wrapper.py

"""
Module: logic.token.database.core.handler.stats.exception.work.wrapper
Author: Banji Lawal
Created: 2026-02-22
version: 1.0.0
"""
...
__all__ = [
    # ======================# TOKEN_STACK_COUNTS_ANALYSIS_FAILURE #======================#
    "TokenStackCountsAnalysisException",
]
...
# ======================# TOKEN_STACK_COUNTS_ANALYSIS_FAILURE #======================#
class TokenStackCountsAnalysisException(ComputationException):
    """
   ...
   None
    ...
    """
    ERR_CODE = "TOKEN_STACK_COUNTS_ANALYSIS_FAILURE"
    MSG = "TokenStackCountsAnalysis failed."
    MTHD = "compute"
    OP_NAME = "Computation"
