# src/logic/tokenContext/context/builder/exception/wrapper.py

"""
Module: logic.tokenContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class TokenContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the TokenContextBuilder method where the process failed.
