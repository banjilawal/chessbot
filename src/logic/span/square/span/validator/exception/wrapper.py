# src/logic/span/square/span/validator/exception/worker.py

"""
Module: logic.span.square.span.validator.exception.work
Author: Banji Lawal
Created: 2026-03-12
Version: 1.0.0
"""
...
class SquareSpanValidationException(ValidationException):
    ...
    Responsibilities:
    1.  Identify the SquareSpanValidationProcess method where the process failed.
