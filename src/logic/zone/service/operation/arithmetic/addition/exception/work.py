...
# ======================# ZONE_ADDITION_FAILURE #======================#
class ZoneAdditionException(ComputationException):
    """
    Role:
    ...
    Responsibilities:
        1.  Indicate that a ZoneAdditionProcess was not completed.
    ...
    """
    MSG = "Zone addition failed."
    ERR_CODE = "ZONE_ADDITION_FAILURE"
