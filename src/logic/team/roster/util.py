...
from logic.team import FillingTeamRosterException, RosterRelationAnalysis, Team, TeamValidationTransaction
...
class RosterUtil:
    ...
    def fill_team_roster(
        ...
        for formation in formation_lookup_result.payload:
            ...
            # Build the token.
            token_build_result = team.roster.integrity_service.build.execute(
                owner=team,
