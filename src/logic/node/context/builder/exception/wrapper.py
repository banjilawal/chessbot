# src/logic/node/context/builder/exception/wrapper.py

"""
Module: logic.node.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
__all__ = [
    # ======================# NODE_CONTEXT_CONTEXT_BUILD_FAILURE #======================#
...
class NodeContextBuildException(BuildException):
    ...
    ERR_CODE = "NODE_CONTEXT_CONTEXT_BUILD_FAILURE"
