# src/logic/node/context/exception/anchor.py

"""
Module: logic.node.context.exception.anchor
Author: Banji Lawal
Created: 2025-10-01
version: 1.0.0
"""
...
class NodeContextException(AnchorException):
    ...
    # RESPONSIBILITIES:
    1.  Anchoring target for NodeContext debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which NodeContext method received a worker's (layer-1) failure result.
