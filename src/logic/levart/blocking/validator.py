...
"""
Module: `logic.owner.travel.blocking.coord_stack_validator`
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class BlockingEventValidator(Validator[BlockingEvent]):
    ...
    def validate(cls, candidate: BlockingEvent) -> ValidationResult[BlockingEvent]:
        ...
        try:
            ...
            actor_validation = BoardActorValidator.search(
                actor=event.actor,
            ...
            resource_validation = TravelResourceValidator.search(
            ...
            blocker_validation = PieceValidator.search(event.friend)
            ...
            context_build_result = DiscoverySearchContextBuilder.search(piece_id=event.friend.visitor_id)
