# src/logic/promotion/promotion/exception.py

"""
Module: logic.promotion.promotion.exception
Author: Banji Lawal
Created: 2025-10-09
version: 1.0.0
...
# src/logic/vector/rollback_exception.py

"""
Module: logic.vector.rollback_exception
Author: Banji Lawal
Created: 2025-10-04
version: 1.0.0
...
class PromotionEventBuild(PromotionEventException, BuilderException):
  ...
  MSG = "PromotionEvent build failed."
...
falls to the `CoordValidator` and `CoordBuildProcess`processes.
...
from logic.exception import RollbackException
from logic.piece import AttackException, InvalidAttackException
