...
from logic.board import Board, BoardContext, BoardSquareFinder
...
class OldPromotionEventBuilder(Builder[PromotionEvent]):
    ...
    def execute(cls, actor: Pawn, execution_environment: Board, parent: Event, new_rank: Rank=Queen) -> BuildResult[PromotionEvent]:
        ...
        try:
            ...
            actor_validator = BoardActorValidator.query(actor, execution_environment)
            ...
            context_build_result = BoardContextBuilder.query(piece_id=actor.visitor_id)
