# src/logic/square/database/core/handler/crud/exception/debug.py

"""
Module: logic.square.database.core.handler.crud.exception.debug
Author: Banji Lawal
Created: 2026-02-22
version: 1.0.0
"""
...
__all__ = [
    # ======================# SQUARE_STACK_CRUD_HANDLER_DEBUG_EXCEPTION #======================#
    "SquareStackCrudHandlerDebugException",
]
...
# ======================# SQUARE_STACK_CRUD_HANDLER_DEBUG_EXCEPTION #======================#
class SquareStackCrudHandlerDebugException(DebugException):
    """
