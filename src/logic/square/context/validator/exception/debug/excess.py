# src/logic/square/context/validator/exception/debug/excess.py

"""
Module: logic.square.context.validator.exception.debug.excess
Author: Banji Lawal
Created: 2025-11-22
version: 1.0.0
"""

from logic.square import SquareContextDebugException
