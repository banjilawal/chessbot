...
class SquareBuilder(Builder[Square]):
    ...
    def _run_build_param_checks(
       ...
       Action:
        ...
        coord_validation = coord_service.validation.validate(coord)
        ...
        board_validation = board_service.validation.validate(board)
    ...
    def _bind_square_board(
        ...
        relation_analysis = board_service.square_relation_analyzer.query(
