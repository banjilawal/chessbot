# src/logic/board/context/finder/exception/debug/payload/kind.py

"""
Module: logic.board.context.finder.exception.debug.payload.kind
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class BoardSearchPayloadTypeException(BoardException, ResultException):
    ...
    None
    """
    ERR_CODE = "BOARD_DATASET_NULL_EXCEPTION"
