...
class BoardContextException(AnchorException):
    ...
    Responsibilities:
    1.  Anchoring target for BoardContext debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which BoardContext method received a worker's (layer-1) failure result.
