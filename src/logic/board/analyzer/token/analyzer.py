# src/logic/board/occupant/analyzer/analyzer.py

"""
Module: logic.board.occupant.analyzer.analyzer
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
from logic.system import RelationAnalyzer
        ...
        if board_validation.is_failure:
            ...
            return RelationReport.failure(
                BoardTokenRelationAnalysisException(
                    msg=f"{method}: {BoardTokenRelationAnalysisException.ERR_CODE}",
