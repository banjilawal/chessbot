"""
Module: logic.projectionSearchContext.rollback_exception
Author: Banji Lawal
Created: 2025-10-04
version: 1.0.0
...
falls to the `BoardSearchContextValidator` and `ProjectionSearchContextBuildTransaction`processes.
...
class ProjectionSearchContextBuildException(ProjectionSearchContextException, BuildException):
    """
    Raised when ProjectionSearchContextBuildTransaction encounters an error while building team_name team_name.
