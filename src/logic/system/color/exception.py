# src/logic/system/color/collision.py

"""
Module: logic.system.color.exception
Author: Banji Lawal
Created: 2025-07-24
"""


from logic.system import ChessException, NullException, ValidationException
...
class NullGameColorException(GameColorException, NullException):
    ...
    ERR_CODE = "NULL_GAME_COLOR_EXCEPTION"
    MSG = "GameColor cannot be null."


class InvalidGameColorException(GameColorException, ValidationException):
    """Super Exception for GameColorValidationTransaction when a candidate fails a sanity check.""""""
