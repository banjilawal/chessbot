# src/logic/system/identity/id/emitter.py

"""
Module: logic.system.identity.id.emitter
Author: Banji Lawal
Created: 2025-07-26
version: 1.0.0
"""
...
class IdEmitter:
    ...
    @property
    def machine_agent(self) -> int:
        self._machine_agent_id += 1
