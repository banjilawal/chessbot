...
class VisitationSearchException(ChessException):
  """
  Super class of exception organic to `SearchProcess` objects. DO NOT USE DIRECTLY. Subclasses give
  details useful for debugging. `FinderException` exists primarily to allow catching all `SearchProcess`
  exception.
  """
  DEFAULT_CODE = "SEARCH_EXCEPTION"
  MSG = "SearchProcess raised an exception."


#======================# SEARCH_COLLISION EXCEPTION #======================#
class VisitationSearchCollisionException(VisitationSearchException, OrphanException):
  DEFAULT_CODE = "VISITATION_SEARCH_COLLISION_EXCEPTION"
  MSG = (
...
class VisitationSearchIdCollisionException(VisitationSearchCollisionException):
  DEFAULT_CODE = "VISITATION_SEARCH_ID_COLLISION_EXCEPTION"
  MSG = (
...
class VisitationSearchNameCollisionException(VisitationSearchCollisionException):
  DEFAULT_CODE = "VISITATION_SEARCH_NAME_COLLISION_EXCEPTION"
  MSG = (
...
class VisitationSearchCoordCollisionException(VisitationSearchCollisionException):
  DEFAULT_CODE = "VISITATION_SEARCH_COORD_COLLISION_EXCEPTION"
  MSG = (
...
class SquareSearchIdCollisionException(OrphanException):
  DEFAULT_CODE = "SQUARE_SEARCH_ID_COLLISION_EXCEPTION"
  MSG = (
...
class SquareSearchNameCollisionException(OrphanException):
  DEFAULT_CODE = "SQUARE_SEARCH_NAME_COLLISION_EXCEPTION"
  MSG = (
...
class SquareSearchCoordCollisionException(OrphanException):
  DEFAULT_CODE = "SQUARE_SEARCH_COORD_COLLISION_EXCEPTION"
  MSG = (
...
class TeamSearchIdCollisionException(OrphanException):
  DEFAULT_CODE = "TEAM_SEARCH_ID_COLLISION_EXCEPTION"
  MSG = (
