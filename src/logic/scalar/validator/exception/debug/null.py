# src/logic/scalar/validation/exception/debug/null.py

"""
Module: logic.scalar.validation.exception.debug.null
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class NullScalarException(NullException):
    ...
    Responsibilities:
    1.  Indicate that a scalar is null where it should not be.
