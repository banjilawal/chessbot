...
class GameContextBuildException(BuildException):
    ...
    Responsibilities:
    1.  Indicate the GameContextBuildTransaction did not produce a valid work product.
    2.  Identify the GameContextBuildTransaction method where the failure occurred.
    ...
    MSG = "Failure in GameContextBuildTransaction method."
