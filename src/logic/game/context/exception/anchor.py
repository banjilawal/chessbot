# src/logic/game/query/exception/anchor.py

"""
Module: logic.game.query.exception.anchor
Author: Banji Lawal
Created: 2025-10-01
version: 1.0.0
"""
...
class GameContextException(AnchorException):
    ...
    Responsibilities:
    1.  Anchoring target for GameContext debug (layer-2) error state firing incident
        reports on
