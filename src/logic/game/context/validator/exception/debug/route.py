# src/logic/game/context/validation/exception/debug/route.py

"""
Module: logic.game.context.validation.exception.debug.route
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class GameContextValidationRouteException(ExecutionRouteException):
   ...
   None
    ...
    """
    MSG = "No validation route for GameContext attribute"
    ERR_CODE = "GAME_CONTEXT_VALIDATION_ROUTE_EXCEPTION"
