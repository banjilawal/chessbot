...
# ======================# ZERO_GAME_CONTEXT_FLAGS_EXCEPTION #======================#
class ZeroGameContextFlagsException(DebugException):
    """
    ...
    1.  Produce the:
        ...
        which occurred in the GameContextValidationTransaction method identified in layer-0 of the exception chain.
   ...
   None
    ...
    """
    MSG = "No GameContext flags are enabled."
