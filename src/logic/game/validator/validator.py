...
class GameValidationProcess(ValidationProcess[Game]):
    """
    ...
    def execute(
        ...
        """
        method = "GameValidationProcess.validate"
        ...
        try:
            ...
            for player in game.players:
                validation = agent_service.validation.execute(player)
