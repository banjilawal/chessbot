# src/logic/attack/service/exception/anchor.py

"""
Module: logic.attack.service.exception.anchor
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# ATTACK_SERVICE_EXCEPTION #======================#
class AttackServiceException(ServiceException):
    """
    # ROLE: Coverage Target, Exception Chain Layer 0

    # RESPONSIBILITIES:
    1.  Anchoring target for AttackService debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which AttackService method received a worker's (layer-1) failure result.
