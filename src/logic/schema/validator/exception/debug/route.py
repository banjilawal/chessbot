...
class SchemaValidationRouteException(ResultException, ExecutionRouteException):
    ...
    Responsibilities:
    1.  Indicate that SchemaValidationTransaction did not handle one of the paths necessary to assure a candidate is a
    ...
    MSG = (
        "The SchemaValidationTransaction did not handle one of the paths necessary to assure a candidate is a safe to use"
