# src/logic/edge/service/exception/anchor.py

"""
Module: logic.edge.service.exception.anchor
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class EdgeServiceException(ServiceException):
    ...
    # RESPONSIBILITIES:
    1.  Anchoring target for EdgeService debug (layer-2) error state firing incident
        reports on
            *   the triggering variable
            *   The trigger's value.
    2.  Indicate which EdgeService method received a worker's (layer-1) failure result.
