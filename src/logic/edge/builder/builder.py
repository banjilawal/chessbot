...
class EdgeBuildTransaction(BuildTransaction[Edge]):
    """
    ...
    def execute(
         ...
         Raises:
             *   EdgeBuildException
         """
         method = "EdgeBuildTransaction.build"
         ...
         head_validation = node_service.validation.execute(candidate=head)
         ...
         tail_validation = node_service.execute.execute(candidate=tail)
