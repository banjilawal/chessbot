# src/logic/coord/database/core/exception/stack/consecutive.py

"""
Module: logic.coord.database.core.exception.stack.consecutive
Author: Banji Lawal
Created: 2025-11-19
version: 1.0.0
"""
...
class MaxConsecutiveCoordPopException(CoordStackException):
        ...
        None
        """
        ERR_CODE = "MAX_CONSECUTIVE_COORD_POP_EXCEPTION"
