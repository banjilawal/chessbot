# src/logic/rank/model/concrete/rook/exception/anchor.py

"""
Module: logic.rank.model.concrete.rook.exception.anchor
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
class RookException(RankException):
    ...
    2.  Indicate which Rook method received a worker's (layer-1) failure result.
