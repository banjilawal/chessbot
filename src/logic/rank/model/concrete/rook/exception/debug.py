# src/logic/rank/model/concrete/rook/exception/debug.py

"""
Module: logic.rank.model.concrete.rook.exception.debug
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
# ======================# ROOK_DEBUG_EXCEPTION #======================#
class RookDebugException(RankDebugException):
    """
    ...
    VAR = Optional[str]
    VAL = Optional[Any]
    ERR_CODE = "ROOK_DEBUG_EXCEPTION"
    MSG = str = "Rook had an error."
