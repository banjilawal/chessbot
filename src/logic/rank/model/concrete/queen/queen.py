...
from logic.rank.model.concrete.queen import QueenException
...
from logic.rank import PerpendicularSpan, QueenSpanComputationException, DiagonalSpan, Rank, Queen
