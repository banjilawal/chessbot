# src/logic/rank/model/concrete/king/exception/debug.py

"""
Module: logic.rank.model.concrete.king.exception.debug
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
# ======================# KING_DEBUG_EXCEPTION #======================#
class KingDebugException(RankDebugException):
    """
    ...
    VAR = Optional[str]
    VAL = Optional[Any]
    ERR_CODE = "KING_DEBUG_EXCEPTION"
    MSG = str = "King had an error."
