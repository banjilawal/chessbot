# src/logic/rank/model/concrete/king/exception/anchor.py

"""
Module: logic.rank.model.concrete.king.exception.anchor
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
class KingException(RankException):
    ...
    2.  Indicate which King method received a worker's (layer-1) failure result.
