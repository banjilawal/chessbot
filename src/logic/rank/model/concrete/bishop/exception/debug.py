# src/logic/rank/model/concrete/bishop/exception/debug.py

"""
Module: logic.rank.model.concrete.bishop.exception.debug
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
# ======================# BISHOP_DEBUG_EXCEPTION #======================#
class BishopDebugException(RankDebugException):
    """
    ...
    VAR = Optional[str]
    VAL = Optional[Any]
    ERR_CODE = "BISHOP_DEBUG_EXCEPTION"
    MSG = str = "Bishop had an error."
