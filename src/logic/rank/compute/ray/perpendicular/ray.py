# src/logic/rank/compute/ray/perpendicular/ray.py

"""
Module: logic.rank.compute.ray.perpendicular.ray
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
from logic.rank import PerpendicularRayComputationException
...
class PerpendicularRay:
    ...
    def compute(
        ...
        PARAMETERS:
            ...
            *   start_y (int):          Starting y value. In practice, it will be occupant.current_position.row.
