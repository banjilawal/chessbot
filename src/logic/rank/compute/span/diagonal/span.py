...
from logic.rank import DiagonalRay, DiagonalSpanComputationException
from logic.system import NUMBER_OF_COLUMNS, ComputationResult, LoggingLevelRouter, NUMBER_OF_ROWS
