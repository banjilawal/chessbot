...
from logic.system import NUMBER_OF_COLUMNS, ComputationResult, LoggingLevelRouter
from logic.rank import PerpendicularRay, PerpendicularSpanComputationException
