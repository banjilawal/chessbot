# src/microservice/integrity/formation/microservice.py

"""
Module: microservice.integrity.formation.microservice.__init__
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class FormationService(HashService[Formation]):
    ...
    def derive_token(
        ...
        square_search_result = team.squares.search_service(context=SquareContext(name=formation.square_name))
