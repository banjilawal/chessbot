...
from domain.model import Vector, VectorBuilder, VectorServiceException, VectorValidator
from system import (
...
class VectorService(Microservice[Vector]):
    ...
    # INHERITED ROLE:
        *   See Microservice class for inherited role.
    ...
    # INHERITED RESPONSIBILITIES:
        *   See Microservice class for inherited responsibilities.
    ...
    def convert_coord_to_vector(
        ...
        coord_validation_result = coord_service.execute.execute(candidate=coord)
