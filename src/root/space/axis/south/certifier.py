# src/certifier/root/space/axis/south/certifier.py

"""
Module: certifier.space.axis.south.certifier
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from toolkit.space.axis.south import SouthAxisToolkit
...
class SouthAxisRootCertifier(AxisRootCertifier[SouthAxisBlueprint]):
    ...
    def execute(self, candidate: Any) -> ValidationResult[SouthAxis| SouthAxisBlueprint]:
        """
        Certify a candidate is a SouthAxisBlueprint that is safe to use.
        ...
        carrier = cast(SouthAxisCarrier, carrier_validation.payload)
            ...
            return ValidationResult.failure(
                SouthAxisRootCertifierException(
                    ...
                    ex=SouthAxisCarrierNullException(
                        cls_mthd=method,
                        cls_name=self.__class__.__name__,
                        msg=SouthAxisCarrierNullException.MSG,
                        err_code=SouthAxisCarrierNullException.ERR_CODE,
                    ),
                )
            )
        ...
        return ValidationResult.success(
            SouthAxisBlueprint(origin=origin)
        )