...
class NorthAxisRootCertifier(AxisRootCertifier[NorthAxisBlueprint]):
    ...
    def execute(self, candidate: Any) -> ValidationResult[NorthAxis| NorthAxisBlueprint]:
        ...
        if carrier_validation.is_failure:
            ...
            return ValidationResult.failure(
                NorthAxisCertifierException(
                    ...
                    msg=NorthAxisCertifierException.MSG,
                    err_code=NorthAxisCertifierException.ERR_CODE,
        ...
        vectors: List[Vector] = []
        for vector in []self.toolkit.math.vector.validator.execute
        ...
        # Handle the case that, northAxis.coord is not safe.
        ...
        # Handle the case that, northAxis.board does not pass a validation check.
        ...
        formation = None
        if carrier.is_home_northAxis_carrier:
