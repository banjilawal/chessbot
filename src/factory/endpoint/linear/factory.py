...
from factory.endpoint.old_quadrant import QuadrantEndpointFactory
from factory.endpoint.axis import AxisEndpointFactory
from err import FactoryException
...
class LinearEndpointFactory:
    ...
    def execute(
        ...
        request = BuildResult.failure(FactoryException())
