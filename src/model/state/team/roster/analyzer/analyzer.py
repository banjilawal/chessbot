# src/model/state/team/relation/roster/validator.py

"""
Module: model.state.team.relation.roster.analyzer
Author: Banji Lawal
Created: 2025-10-06
version: 1.0.0
"""
...
from model.state.token import Token, TokenService, TokenContext
from system import LoggingLevelRouter, RelationReport, RelationAnalysis
from model.state.team import Team, TeamRosterRelationAnalysisException, TeamValidator
...
class RosterRelationAnalysis(RelationAnalysis[Team, Token]):
    ...
    def execute(
        ...
        team_validation = team_validator.build(candidate_primary)
        ...
        piece_validation = piece_service.validate.search_service(candidate_satellite)
