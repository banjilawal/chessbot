# src/model/state/team/roster/util/util.py

"""
Module: model.state.team.roster.util.util
Author: Banji Lawal
Created: 2026-02-22
version: 1.0.0
"""
...
from model.state.team import FillingTeamRosterException, RosterRelationAnalysis, Team, TeamValidator
...
class RosterUtil:
    ...
    def fill_team_roster(
        ...
        team_validation = team_validator.build(candidate=team)
