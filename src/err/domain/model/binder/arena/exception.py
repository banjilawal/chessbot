# src/err/domain/model/ArenaPlayerBinder/exception.py

"""
Module: err.domain.model.ArenaPlayerBinder.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class ArenaPlayerBinderException(BinderException):
    ...
    Responsibilities:
        1.  Indicating a ArenaPlayerBinder encountered an error.
