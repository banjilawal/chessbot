# src/err/domain/search/context/formation/exception.py

"""
Module: err.domain.search.context.formation.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class FormationContextException(ContextException):
    ...
    Responsibilities:
        1.  Indicating a FormationContext encountered an error.
