# src/err/domain/transit/space/axis/east/exception.py

"""
Module: err.domain.transit.space.axisCarrier experienced an error.east.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class EastAxisCarrierException(AxisCarrierException):
    ...
    Responsibilities:
        1.  Indicating a EastAxisCarrier experienced an error.
