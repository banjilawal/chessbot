# src/err/carrier_validator/operation/attack/empty/exception.py

"""
Module: err.carrier_validator.operation.attack.empty.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class AttackDestinationEmptyException(AttackException):
    ...
    Super Class:
        AttackException
    """
    MSG = "Token cannot attack an empty destination."
    ERR_CODE = "EMPTY_ATTACK_DESTINATION_ERROR"
