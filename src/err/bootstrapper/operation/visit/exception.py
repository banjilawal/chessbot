# src/err/carrier_validator/operation/visit/exception.py

"""
Module: err.carrier_validator.operation.visit.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# SQUARE_VISIT_FAILURE #======================#
class SquareVisitException(OperationBootstrapperException):
    """
    Role:
        -   Error Tracing
