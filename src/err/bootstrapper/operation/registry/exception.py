# src/err/carrier_validator/operation/registry/exception.py

"""
Module: err.carrier_validator.operation.registry.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# REGISTRY_OPERATION_FAILURE #======================#
class RegistryOperationBootstrapperException(OperationBootstrapperException):
    """
    Role:
        -   Error Tracing
