# src/err/carrier_validator/operation/push/token/quota/exception.py

"""
Module: err.carrier_validator.operation.push.token.quota.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class RankQuotaFullException(TokenPusherException):
    ...
    """
    MSG = "The rank is already full."
    ERR_CODE = "TNO_OPENINGS_FOR_RANK_ERROR"
