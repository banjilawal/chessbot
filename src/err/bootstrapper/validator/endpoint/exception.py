...
__all__ = [
    ...
    "EndpointValidatorBootstrapperException",
]

# ======================# MANEUVER_VALIDATOR_BOOTSTRAPPER_FAILURE #======================#
class EndpointValidatorBootstrapperException(ValidatorBootstrapperException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicating a ManeuverValidatorBootstrapper from
            completing its task.
