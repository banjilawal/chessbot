# src/err/bootstrap/detector/collider/square/exception.py

"""
Module: err.bootstrap.detector.collider.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
__all__ = [
    ...
    "SquareColliderBootstrapperException",
]

# ======================# SQUARE_COLLISION_DETECTOR_FAILURE #======================#
class SquareColliderBootstrapperException(DetectorBootstrapperException):
    """
    Role:
        -   Error Tracing
