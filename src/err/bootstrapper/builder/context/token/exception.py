# src/err/carrier_validator/builder/context/token/exception.py

"""
Module: err.carrier_validator.builder.context.token.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class TokenContextBuilderBootstrapperException(ContextBuilderBootstrapperException):
    ...
    Responsibilities:
        1.  Indicating a TokenContextBuilderBootstrapper was aborted by an exception.
