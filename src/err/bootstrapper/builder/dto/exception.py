# src/err/bootstrapper/builder/dto/exception.py

"""
Module: err.bootstrapper.builder.dto.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class DtoBuilderBootstrapperException(BuilderBootstrapperException):
    ...
    Responsibilities:
        1.  Indicate that an error prevented the DtoBuilderBootstrapper from completing its task.
