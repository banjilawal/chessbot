...
__all__ = [
    # ======================# BINDER_BUILDER_BOOTSTRAPPER_FAILURE #======================#
...
class BinderBuilderBootstrapperException(BuilderBootstrapperException):
    ...
    Responsibilities:
        1.  Indicate that an error prevented the BinderBuilderBootstrapper from completing its task.
   ...
   BuilderBootstrapper from completing its task.s:
    ...
    """
    MSG = "binder'sBuilderBootstrapper failure."
    ERR_CODE = "BINDER_BUILDER_BOOTSTRAPPER_FAILURE"
