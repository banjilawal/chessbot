...
# ======================# ORIGIN_SEARCHER_BOOTSTRAPPER_FAILURE #======================#
class OriginSearcherBootstrapperException(SearcherBootstrapperException):
    """
    Role:
        - Error Tracing

    Responsibilities:
        1.  Indicating a OriginSearcherBootstrapper from
            completing its task.
    ...
    """
    MSG = "OriginSearcherBootstrapper encountered an error."
    ERR_CODE = "ORIGIN_SEARCHER_BOOTSTRAPPER_FAILURE"
