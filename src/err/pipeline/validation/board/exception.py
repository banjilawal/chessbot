# src/err/pipeline/validation/board/exception.py

"""
Module: err.pipeline.validation.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class BoardValidationPipelineException(ValidationPipelineException):
    ...
    Responsibilities:
        1.  Indicate that an error occurred in a BoardValidationPipeline.
