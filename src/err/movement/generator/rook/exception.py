...
__all__ = [
    ...
    "RookSignatureGeneratorException",
]


# ======================# ROOK_SIGNATURE_GENERATOR_FAILURE #======================#
class RookSignatureGeneratorException(SignatureGeneratorException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicating a RookPatternGenerator did not complete its task.
