...
__all__ = [
    # ======================# REGISTER_ENTITY_CARRIER_NULL_ERROR #======================#
...
class RegisterEntityNullException(EntityCarrierNullException):
    ...
    Responsibilities:
        1.  Indicate that a required RegisterEntityCarrier is null.
    ...
    """
    MSG = "RegisterEntityEntityCarrier cannot be null."
    ERR_CODE= "REGISTER_ENTITY_CARRIER_NULL_ERROR"
