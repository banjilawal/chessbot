# src/err/null/pattern/offset/pawn/maneuver/exception.py

"""
Module: err.null.pattern.offset.pawn.maneuver.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class ManeuverOffsetPatternNullException(PawnOffsetSignatureNullException):
    ...
    Responsibilities:
        1.  Indicating an error occurred in an ManeuverOffsetPattern is null.
