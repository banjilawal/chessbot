...
__all__ = [
    # ======================# VECTOR_VECTOR_REGISTER_BLUEPRINT_NULL_ERROR #======================#
    "VectorRegisterBlueprintNullException",
]

# ======================# VECTOR_VECTOR_REGISTER_BLUEPRINT_NULL_ERROR #======================#
class VectorRegisterBlueprintNullException(RegisterBlueprintNullException):
    """
    Role:
        -   Error Tracing
    ...
    ERR_CODE = "VECTOR_REGISTER_BLUEPRINT_NULL_ERROR"
