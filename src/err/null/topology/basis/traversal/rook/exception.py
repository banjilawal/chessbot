# src/err/null/pattern/traversal/rook/exception.py

"""
Module: err.null.pattern.traversal.rook.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class RookTraversalSignatureNullException(TraversalSignatureNullException):
    ...
    """
    MSG = "RookTraversalPattern cannot be null."
    ERR_CODE = "ROOK_TRAVERSAL_PATTERN_NULL_ERROR"
