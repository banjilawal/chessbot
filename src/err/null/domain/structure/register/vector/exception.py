# src/err/null/domain/structure/register/vector/exception.py

"""
Module: err.null.domain.structure.register.vector.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# VECTOR_REGISTER_NULL_ERROR #======================#
class VectorRegisterNullException(ModelRegisterNullException):
    """
    Role:
        -   Error Tracing
