# src/err/null/domain/model/state/square/square/exception.py

"""
Module: err.null.domain.model.state.square.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# SQUARE_STATE_NULL_ERROR #======================#
class SquareStateNullException(SquareNullException):
    """
    Role:
        - Error Tracing
