# src/err/null/domain/model/state/player/exception.py

"""
Module: err.null.domain.model.state.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# PLAYER_NULL_ERROR #======================#
class PlayerNullException(StateModelNullException):
    """
    Role:
        -   Error Tracing
