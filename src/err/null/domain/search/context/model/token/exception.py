# src/err/null/domain/search/context/model/token/exception.py

"""
Module: null.domain.search.context.model.token.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# TOKEN_CONTEXT_NULL_ERROR #======================#
class TokenContextNullException(ModelContextNullException):
    """
    Role:
        - Error Tracing
