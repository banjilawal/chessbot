# src/err/null/domain/blueprint/model/vector/exception.py

"""
Module: err.null.domain.blueprint.model.vector.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# VECTOR_BLUEPRINT_NULL_ERROR #======================#
class VectorBlueprintNullException(ModelBlueprintNullException):
    """
    Role:
        -   Error Tracing
