# src/err/null/domain/blueprint/model/walk/maneuver/exception.py

"""
Module: err.null.domain.blueprint.model.walk.maneuver.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
__all__ = [
    ...
    "ManeuverBlueprintNullException",
]
...
class ManeuverBlueprintNullException(BlueprintNullException):
    ...
    Responsibilities:
        1.  Indicating a required ManeuverBlueprint is null.
