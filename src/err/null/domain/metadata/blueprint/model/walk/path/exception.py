# src/err/null/domain/blueprint/model/walk/path/exception.py

"""
Module: err.null.domain.blueprint.model.walk.path.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class PathBlueprintNullException(BlueprintNullException):
    ...
    Responsibilities:
        1.  Indicating a required PathBlueprint is null.
