# src/err/null/operand/register/identity/exception.py

"""
Module:err.null.operand.register.identity.exception
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
__all__ = [
    ...
    "VectorIdentityRegisterDtoOperandNullException",
]

# ======================# VECTOR_IDENTITY_REGISTER_OPERAND_ERROR #======================#
class VectorIdentityRegisterDtoOperandNullException(NullRegisterException):
    """
    Role:
        -   Error Tracing
