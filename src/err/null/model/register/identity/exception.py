...
__all__ = [
    ...
    "VectorIdentityRegisterNullException",
]

# ======================# VECTOR_IDENTITY_REGISTER_NULL_ERROR #======================#
class VectorIdentityRegisterNullException(RegisterNullException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicate that a required VectorIdentityRegister encountered is null.
