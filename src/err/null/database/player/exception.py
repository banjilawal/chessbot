# src/err/null/database/player/exception.py

"""
Module: err.null.database.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class PlayerDatabaseNullException(DatabaseNullException):
    ...
    """
    MSG = "PlayerDatabase cannot be null."
    ERR_CODE = "PLAYER_DATABASE_NULL_ERROR"
