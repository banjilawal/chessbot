# src/err/null/database/board/exception.py

"""
Module: err.null.database.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
__all__ = [
    ...
    "BoardStacNullException",
]

# ======================# BOARD_DATABASE_NULL_EXCEPTION #======================#
class BoardStacNullException(DatabaseNullException):
    """
    Role:
        -   Error Tracing
