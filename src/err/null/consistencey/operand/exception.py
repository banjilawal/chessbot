...
__all__ = [
    # ======================# VECTOR_OPERAND_CONSISTENCY_CHECKER_NULL_ERROR #======================#
...
class VectorOperandConsistencyCheckerNullException(ConsistencyCheckerNullException):
    ...
    Responsibilities:
        1.  Indicate that a VectorOperandConsistencyChecker is null.
    ...
    ERR_CODE = "VECTOR_OPERAND_CONSISTENCY_CHECKER_NULL_ERROR"
