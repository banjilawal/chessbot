# src/err/bidirectional/missing/exception.py

"""
Module: err.bidirectional.missing.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class MissingRegistrationException(BidirectionalRelationException):
    ...
    """
    MSG = "Satellite has not registered its association with its primary."
    ERR_CODE = "MISSING_REGISTRATION_ERROR"
