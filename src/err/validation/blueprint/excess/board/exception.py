# src/err/validation/blueprint/excess/board/exception.py

"""
Module: err.validation.blueprint.excess.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
_all_ = [
    # ======================# EXCESS_BOARD_BLUEPRINT_FLAGS_FAILURE #======================#
...
class ExcessBoardBlueprintFlagsException(ExcessBlueprintFlagsException):
    ...
    """
    MSG = "More than one BoardCCertifier test. enabled."
