# src/err/validation/blueprint/excess/persona/exception.py

"""
Module: err.validation.blueprint.excess.persona.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
_all_ = [
    # ======================# EXCESS_PERSONA_BLUEPRINT_FLAGS_FAILURE #======================#
...
class ExcessPersonaBlueprintFlagsException(ExcessBlueprintFlagsException):
    ...
    """
    MSG = "Candidate did not pass a More than one PersonaCBlueprintValidator test. enabled."
