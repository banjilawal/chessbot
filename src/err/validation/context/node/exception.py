# src/err/validation/context/node/exception.py

"""
Module: err.validation.context.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class NodeContextValidatorException(ContextValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate did not pass a NodeContextValidator test.
