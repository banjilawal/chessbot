# src/err/validation/context/hostage/exception.py

"""
Module: err.validation.context.hostage.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class HostageContextValidatorException(ContextValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate did not pass a HostageContextValidator test.
