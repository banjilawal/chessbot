# src/err/validation/context/schema/exception.py

"""
Module: err.validation.context.schema.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class SchemaContextValidatorException(ContextValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate did not pass a SchemaContextValidator test.
