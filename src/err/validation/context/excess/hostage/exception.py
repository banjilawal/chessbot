# src/err/validation/context/excess/hostage/exception.py

"""
Module: err.validation.context.excess.hostage.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# EXCESS_HOSTAGE_CONTEXT_FLAGS_FAILURE #======================#
class ExcessHostageTogglesException(ExcessTogglesException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicates that more than one HostageContext option was enabled.
