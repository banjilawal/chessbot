# src/err/validation/context/excess/persona/exception.py

"""
Module: err.validation.context.excess.persona.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ExcessPersonaContextFlagsException(ExcessContextFlagsException):
    ...
    Responsibilities:
        1.  Indicates that more than one PersonaContext option was enabled.
    ...
    """
    MSG = "Candidate did not pass a More than one PersonaCContextValidator test. enabled."
