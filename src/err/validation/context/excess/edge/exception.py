# src/err/validation/context/excess/edge/exception.py

"""
Module: err.validation.context.excess.edge.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ExcessEdgeContextFlagsException(ExcessContextFlagsException):
    ...
    Responsibilities:
        1.  Indicates that more than one EdgeContext option was enabled.
    ...
    """
    MSG = "Candidate did not pass a More than one EdgeCContextValidator test. enabled."
