# src/err/validation/context/coord/exception.py

"""
Module: err.validation.context.coord.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class CoordContextValidatorException(ContextValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate did not pass a CoordContextValidator check.
