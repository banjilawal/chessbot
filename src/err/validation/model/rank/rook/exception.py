# src/err/validation/model/rank/rook/exception.py

"""
Module: err.validation.model.rank.rook.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class RookValidatorException(RankValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate failed a Rook validator test.
