# src/err/validation/model/state/path/combatant/exception.py

"""
Module: err.validation.model.state.path.combatant.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class CombatantPathValidatorException(PathValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate failed a CombatantPathValidator test.
