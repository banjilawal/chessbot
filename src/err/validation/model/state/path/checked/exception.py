# src/err/validation/model/state/path/checked/exception.py

"""
Module: err.validation.model.state.path.checked.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class CheckedPathValidatorException(PathValidatorException):
    ...
    Responsibilities:
        1.  Indicate that a candidate failed a CheckedPathValidator test.
