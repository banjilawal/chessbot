# src/err/model/context/zero/board/__init__.py

"""
Module: err.model.context.zero.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ZeroBoardContextFlagsException(ZeroContextFlagsException):
    ...
    Responsibilities:
        1.  Indicates that no BoardContext option was enabled.
    ...
    """
    MSG = str = "No BoardCcontext option was enabled."
