# src/err/model/context/excess/player/exception.py

"""
Module: err.model.context.excess.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ExcessPlayerContextFlagsException(ExcessContextFlagsException):
    ...
    """
    MSG = str = "More than one PlayerCcontext attribute enabled."
