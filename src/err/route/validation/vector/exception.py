...
__all__ = [
    ...
    "VectorNoValidationRouteException",
]

# ======================# VECTOR_VALIDATION_ROUTE #======================#
class VectorNoValidationRouteException(NoValidationRouteException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "One of Vector validation paths is missing."
    ERR_CODE = "VECTOR_VALIDATION_ROUTE"
