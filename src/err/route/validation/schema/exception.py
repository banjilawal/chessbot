...
# ======================# SCHEMA_VALIDATION_ROUTE #======================#
class SchemaNoValidationRouteException(NoValidationRouteException):
    """
    Role:
        - Error Tracing

    Responsibilities:
        1.  Indicating that one of Schema validation routes is missing.
    ...
    """
    MSG = "One of Schema validation paths is missing."
    ERR_CODE = "SCHEMA_VALIDATION_ROUTE"
