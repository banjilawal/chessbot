...
class ValidationRouteException(ExecutionRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no execution logic for a validation path.
    ...
    """
    MSG = str = "N execution logic for the validation path"
    ERR_CODE = "VALIDATION_ROUTE_EXCEPTION"
