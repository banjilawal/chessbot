...
__all__ = [
    # ======================# HOSTAGE_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class HostageContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a HostageContext field.
    ...
    ERR_CODE = "HOSTAGE_CONTEXT_VALIDATION_PATH_EXCEPTION"
