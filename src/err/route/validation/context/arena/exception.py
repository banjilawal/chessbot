...
__all__ = [
    # ======================# ARENA_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class ArenaContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a ArenaContext field.
    ...
    ERR_CODE = "ARENA_CONTEXT_VALIDATION_PATH_EXCEPTION"
