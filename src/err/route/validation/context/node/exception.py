...
# ======================# NODE_CONTEXT_VALIDATION_ROUTE #======================#
class NodeContextValidationRouteException(ContextNoValidationRouteException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "A NodeContext attribute missing a validation path."
    ERR_CODE = "NODE_CONTEXT_VALIDATION_ROUTE"
