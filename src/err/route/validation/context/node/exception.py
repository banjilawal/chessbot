...
__all__ = [
    # ======================# NODE_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class NodeContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a NodeContext field.
    ...
    ERR_CODE = "NODE_CONTEXT_VALIDATION_PATH_EXCEPTION"
