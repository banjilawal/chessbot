...
__all__ = [
    # ======================# SCHEMA_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class SchemaContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a SchemaContext field.
    ...
    ERR_CODE = "SCHEMA_CONTEXT_VALIDATION_PATH_EXCEPTION"
