...
__all__ = [
    # ======================# PERSONA_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class PersonaContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a PersonaContext field.
    ...
    ERR_CODE = "PERSONA_CONTEXT_VALIDATION_PATH_EXCEPTION"
