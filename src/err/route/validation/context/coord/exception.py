...
class CoordContextValidationRouteException(ContextNoValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that one of CoordContext validation routes is missing.
    ...
    """
    MSG = "A CoordContext attribute missing a validation path."
    ERR_CODE = "COORD_CONTEXT_VALIDATION_ROUTE"
