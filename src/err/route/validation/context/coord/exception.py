...
__all__ = [
    # ======================# COORD_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class CoordContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a CoordContext field.
    ...
    """
    MSG = str = "No validation logic for CoordContext attribute"
    ERR_CODE = "COORD_CONTEXT_VALIDATION_PATH_EXCEPTION"
