...
__all__ = [
    # ======================# RANK_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class RankContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a RankContext field.
    ...
    ERR_CODE = "RANK_CONTEXT_VALIDATION_PATH_EXCEPTION"
