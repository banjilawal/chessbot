...
__all__ = [
    # ======================# GAME_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class GameContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a GameContext field.
    ...
    ERR_CODE = "GAME_CONTEXT_VALIDATION_PATH_EXCEPTION"
