...
__all__ = [
    # ======================# TOKEN_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class TokenContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a TokenContext field.
    ...
    ERR_CODE = "TOKEN_CONTEXT_VALIDATION_PATH_EXCEPTION"
