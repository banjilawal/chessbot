...
__all__ = [
    # ======================# FORMATION_CONTEXT_VALIDATION_PATH_EXCEPTION #======================#
...
class FormationContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that there is no validation path for a FormationContext field.
    ...
    ERR_CODE = "FORMATION_CONTEXT_VALIDATION_PATH_EXCEPTION"
