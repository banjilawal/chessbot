# MISSING_src/err/route/validation/context/formation/exception.py
...
__all__ = [
    # ======================# MISSING_FORMATION_CONTEXT_VALIDATION_ROUTE #======================#
...
class FormationContextValidationRouteException(ContextValidationRouteException):
    ...
    Responsibilities:
        1.  Indicate that one of FormationContext validation routes is missing.
    ...
    """
    MSG = "A FormationContext attribute missing a validation path."
    ERR_CODE = "FORMATION_CONTEXT_VALIDATION_ROUTE"
