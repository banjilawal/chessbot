...
__all__ = [
    ...
    "EdgeNoValidationRouteException",
]

# ======================# EDGE_VALIDATION_ROUTE #======================#
class EdgeNoValidationRouteException(NoValidationRouteException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "One of Edge validation paths is missing."
    ERR_CODE = "EDGE_VALIDATION_ROUTE"
