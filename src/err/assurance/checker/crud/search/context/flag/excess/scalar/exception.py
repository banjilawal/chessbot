# src/err/assurance/checker/crud/search/context/flag/excess/scalar/exception.py

"""
Module: err.assurance.checker.crud.search.context.flag.excess.scalar.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
__all__ = [
    # ======================# EXCESSIVE_SCALAR_CONTEXT_FLAGS_ENABLED #======================#
    "ExcessScalarContextFlagsException",
]
