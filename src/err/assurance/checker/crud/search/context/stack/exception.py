# src/err/assurance/checker/crud/search/context/stack/exception.py

"""
Module: err.assurance.checker.crud.search.context.stack.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# STACK_CONTEXT_CHECKER_FAILURE #======================#
class ContextCheckerException(ContextCheckerException):
    """
    Role:
        - Error Tracing
