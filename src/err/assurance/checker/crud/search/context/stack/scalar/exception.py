# src/err/assurance/checker/crud/search/context/stack/scalar/exception.py

"""
Module: err.assurance.checker.crud.search.context.stack.scalar.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# SCALAR_CONTEXT_CHECKER_FAILURE #======================#
class ScalarContextCheckerException(ContextCheckerException):
    """
    Role:
        - Error Tracing
