# src/err/assurance/checker/crud/search/context/stack/vector/exception.py

"""
Module: err.assurance.checker.crud.search.context.stack.vector.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# VECTOR_CONTEXT_CHECKER_FAILURE #======================#
class VectorContextCheckerException(ContextCheckerException):
    """
    Role:
        - Error Tracing
