# src/err/assurance/checker/crud/search/context/graph/exception.py

"""
Module: err.assurance.checker.crud.search.context.graph.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
