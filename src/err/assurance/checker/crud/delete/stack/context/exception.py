...
__all__ = [
    ...
    "PopStackByContextCheckerException",
]

# ======================# REMOVE_NODE_BY_CONTEXT_CHECKER_FAILURE #======================#
class PopStackByContextCheckerException(PopStackCheckerException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicating assurance by a PopStackByContextChecker failed.
    ...
    """
    MSG = "PopStackByContextChecker failure."
