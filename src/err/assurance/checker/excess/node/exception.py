# src/err/assurance/checker/excess/node/exception.py

"""
Module: err.assurance.checker.excess.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class ExcessNodeBlueprintFlagsException(ExcessBlueprintFlagsException):
    ...
    Responsibilities:
        1.  Indicatings that more than one NodeBlueprint option was enabled.
