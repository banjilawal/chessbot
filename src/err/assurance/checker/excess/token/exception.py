# src/err/assurance/checker/excess/token/exception.py

"""
Module: err.assurance.checker.excess.token.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class ExcessTokenBlueprintFlagsException(ExcessBlueprintFlagsException):
    ...
    Responsibilities:
        1.  Indicatings that more than one TokenBlueprint option was enabled.
