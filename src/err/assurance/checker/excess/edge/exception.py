# src/err/assurance/checker/excess/edge/exception.py

"""
Module: err.assurance.checker.excess.edge.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class ExcessEdgeBlueprintFlagsException(ExcessBlueprintFlagsException):
    ...
    Responsibilities:
        1.  Indicatings that more than one EdgeBlueprint option was enabled.
