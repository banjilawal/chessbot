# src/err/assurance/checker/zero/vector/exception.py

"""
Module: err.assurance.checker.zero.vector.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
_all_ = [
    # ======================# ZERO_VECTOR_TOGGLE_FLAGS_FAILURE #======================#
    "ZeroVectorToggleFlagsException",
]

# ======================# ZERO_VECTOR_TOGGLE_FLAGS_FAILURE #======================#
class ZeroVectorToggleFlagsException(ZeroBlueprintFlagsException):
    """
    Role:
        -   Error Tracing
