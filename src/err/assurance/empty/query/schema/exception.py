# src/err/assurance/empty/query/schema/exception.py

"""
Module: err.assurance.empty.schema.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class SchemaQueryStackEmptyException(QueryStackEmptyException):
    ...
    Responsibilities:
        1.  Indicating a required SchemaQuery's target stack is empty.
