# src/err/assurance/empty/space/linear/segment/exception.py

"""
Module: err.assurance.empty.space.segment.segment.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class LineSegmentEmptyException(LinearSpaceEmptyException):
    ...
    """
    MSG = "LineSegment cannot have empty endpoints."
    ERR_CODE = "EMPTY_LINE_SEGMENT_ENDPOINTS_ERROR"
