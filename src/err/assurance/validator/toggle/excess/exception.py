# src/err/assurance/validator/toggle/excess/exception.py

"""
Module: err.assurance.validator.toggle.excess.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# EXCESSIVE_TOGGLE_ACTIVATION_ERROR #======================#
class ExcessToggleActivationException(EntityCarrierValidatorException):
    """
    Role:
        -   Error Tracing
        
    Responsibilities:
        1.  Indicating that too many switches in a Toggle are on.
