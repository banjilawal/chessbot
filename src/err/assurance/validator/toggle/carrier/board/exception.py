# src/err/assurance/validator/toggle/carrier/board/exception.py

"""
Module: err.assurance.validator.toggle.carrier.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class BoardCarrierValidatorException(EntityCarrierValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a BoardCarrierValidator test.
