# src/err/assurance/validator/search/stack/token/exception.py

"""
Module: err.assurance.validator.search.stack.token.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
# ======================# TOKEN_CONTEXT_VALIDATOR_FAILURE #======================#
class TokenContextValidatorException(SearchContextValidatorException):
    """
    Role:
        - Error Tracing
    ...
    """
    MSG = "TokenContextValidator failed."
