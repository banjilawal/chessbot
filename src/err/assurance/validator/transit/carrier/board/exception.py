# src/err/assurance/validator/transit/carrier/board/exception.py

"""
Module: err.assurance.validator.transit.carrier.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class BoardCarrierValidatorException(EntityCarrierValidatorException):
    ...
    Responsibilities:
        1.  Indicating assurance by a BoardCarrierValidator failed.
