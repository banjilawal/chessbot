# src/err/assurance/validator/model/state/square/exception.py

"""
Module: err.assurance.validator.model.state.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class SquareValidatorException(StateModelValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a SquareValidator test.
