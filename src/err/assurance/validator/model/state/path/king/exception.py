# src/err/assurance/validator/model/state/path/king/exception.py

"""
Module: err.assurance.validator.model.state.path.king.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class KingPathValidatorException(PathValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a KingPathValidator test.
