# src/err/assurance/validator/model/state/path/blocked/exception.py

"""
Module: err.assurance.validator.model.state.path.blocked.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class BlockedPathValidatorException(PathValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a BlockedPathValidator test.
