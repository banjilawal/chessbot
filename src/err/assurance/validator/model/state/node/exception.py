# src/err/assurance/validator/model/state/node/exception.py

"""
Module: err.assurance.validator.model.state.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class NodeValidatorException(StateModelValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a NodeValidator test.
