# src/err/assurance/validator/model/rank/king/exception.py

"""
Module: err.assurance.validator.model.rank.king.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class KingValidatorException(RankValidatorException):
    ...
    Responsibilities:
        1.  Indicating a candidate failed a King validator test.
