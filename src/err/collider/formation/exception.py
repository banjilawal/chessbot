# src/err/collider/formation/exception.py

"""
Module: err.collider.formation.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
__all__ = [
    ...
    "FormationColliderException",
]

# ======================# FORMATION_COLLISION_FAILURE #======================#
class FormationColliderException(ColliderException):
    """
    Role:
        -   Error Tracing
