# src/err/collider/context/persona/exception.py

"""
Module: err.collider.context.persona.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# PERSONA_CONTEXT_COLLISION_FAILURE #======================#
class PersonaContextCollisionException(ContextColliderException):
    """
    Role:
        -   Error Tracing
