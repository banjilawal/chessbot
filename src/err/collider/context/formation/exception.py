# src/err/collider/context/formation/exception.py

"""
Module: err.collider.context.formation.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# FORMATION_CONTEXT_COLLISION_FAILURE #======================#
class FormationContextCollisionException(ContextColliderException):
    """
    Role:
        -   Error Tracing
