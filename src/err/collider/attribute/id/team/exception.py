...
__all__ = [
    # ======================# TEAM_ID_COLLISION_ERROR #======================#
    "TeamIdCollisionException",
]

# ======================# TEAM_ID_COLLISION_ERROR #======================#
class TeamIdCollisionException(IdCollisionException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "The team id is already in use."
    ERR_CODE = "TEAM_ID_COLLISION_ERROR"
