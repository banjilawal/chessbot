...
# ======================# COORD_COLLISION_ERROR #======================#
class CoordCollisionException(AttributeCollisionException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicating that two instances of a class do not have unique coords.
