# src/err/collider/id/square/exception.py

"""
Module: err.collider.id.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
from err import IdColliderException
...
# ======================# SQUARE_ID_COLLISION_ERROR #======================#
class SquareIdCollisionException(IdColliderException):
    """
    Role:
        -   Error Tracing
