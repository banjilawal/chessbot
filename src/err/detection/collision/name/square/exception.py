# src/err/detection/collision/name/square/exception.py

"""
Module: err.detection.collision.name.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# SQUARE_NAME_COLLISION_ERROR #======================#
class SquareNameCollisionException(NameCollisionDetectorException):
    """
    Role:
        -   Error Tracing
