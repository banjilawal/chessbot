# src/err/detection/collision/square/exception.py

"""
Module: err.detection.collision.square.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# SQUARE_COLLISION_DETECTOR_FAILURE #======================#
class SquareCollisionDetectorException(DetectorException):
    """
    Role:
        -   Error Tracing
