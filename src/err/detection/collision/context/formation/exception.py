# src/err/detection/collision/context/formation/exception.py

"""
Module: err.detection.collision.context.formation.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# FORMATION_CONTEXT_COLLISION_FAILURE #======================#
class FormationContextCollisionException(ContextCollisionDetectorException):
    """
    Role:
        -   Error Tracing
