# src/err/detection/collision/context/board/exception.py

"""
Module: err.detection.collision.context.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# BOARD_CONTEXT_COLLISION_FAILURE #======================#
class BoardContextCollisionException(ContextCollisionDetectorException):
    """
    Role:
        -   Error Tracing
