# src/err/detection/collision/context/schema/exception.py

"""
Module: err.detection.collision.context.schema.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
__all__ = [
    # ======================# SCHEMA_CONTEXT_COLLISION_FAILURE #======================#
...
# ======================# SCHEMA_CONTEXT_COLLISION_FAILURE #======================#
class SchemaContextCollisionException(ContextCollisionDetectorException):
    """
    Role:
        -   Error Tracing
