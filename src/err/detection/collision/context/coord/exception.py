# src/err/detection/collision/context/coord/exception.py

"""
Module: err.detection.collision.context.coord.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# COORD_CONTEXT_COLLISION_FAILURE #======================#
class CoordContextCollisionException(ContextCollisionDetectorException):
    """
    Role:
        -   Error Tracing
