...
__all__ = [
    # ======================# BOOTSTRAPPING_HOSTAGE_ASSEMBLY_ #======================#
    "BootstrapHostageAssemblyException",
]

# ======================# BOOTSTRAPPING_HOSTAGE_ASSEMBLY_ #======================#
class BootstrapHostageAssemblyException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "HostageAssembly bootstrap step failed."
    ERR_CODE = "BOOTSTRAPPING_HOSTAGE_ASSEMBLY_"
