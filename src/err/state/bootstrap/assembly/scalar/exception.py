...
__all__ = [
    # ======================# BOOTSTRAPPING_SCALAR_ASSEMBLY_FAILURE #======================#
    "BootstrapScalarAssemblyException",
]

# ======================# BOOTSTRAPPING_SCALAR_ASSEMBLY_FAILURE #======================#
class BootstrapScalarAssemblyException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "ScalarAssembly bootstrap step failed."
    ERR_CODE = "BOOTSTRAPPING_SCALAR_ASSEMBLY_FAILURE"
