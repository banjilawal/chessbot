...
__all__ = [
    # ======================# PERSONA_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
    "PersonaAssemblyBootstrapperException",
]

# ======================# PERSONA_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
class PersonaAssemblyBootstrapperException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "PersonaAssembly bootstrap step failed."
    ERR_CODE = "PERSONA_BOOTSTRAP_ASSEMBLY_FAILURE"
