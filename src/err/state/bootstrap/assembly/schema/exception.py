...
__all__ = [
    # ======================# SCHEMA_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
    "SchemaAssemblyBootstrapperException",
]

# ======================# SCHEMA_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
class SchemaAssemblyBootstrapperException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "SchemaAssembly bootstrap step failed."
    ERR_CODE = "SCHEMA_BOOTSTRAP_ASSEMBLY_FAILURE"
