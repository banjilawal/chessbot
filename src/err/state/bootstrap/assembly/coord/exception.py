...
__all__ = [
    # ======================# BOOTSTRAPPING_COORD_ASSEMBLY_FAILURE #======================#
    "BootstrapCoordAssemblyException",
]

# ======================# BOOTSTRAPPING_COORD_ASSEMBLY_FAILURE #======================#
class BootstrapCoordAssemblyException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "CoordAssembly bootstrap step failed."
    ERR_CODE = "BOOTSTRAPPING_COORD_ASSEMBLY_FAILURE"
