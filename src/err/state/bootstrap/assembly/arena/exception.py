...
__all__ = [
    # ======================# BOOTSTRAPPING_ARENA_ASSEMBLY_FAILURE #======================#
    "BootstrapArenaAssemblyException",
]

# ======================# BOOTSTRAPPING_ARENA_ASSEMBLY_FAILURE #======================#
class BootstrapArenaAssemblyException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "ArenaAssembly bootstrap step failed."
    ERR_CODE = "BOOTSTRAPPING_ARENA_ASSEMBLY_FAILURE"
