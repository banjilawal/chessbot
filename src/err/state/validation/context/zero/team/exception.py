# src/err/state/validation/context/zero/team/__init__.py

"""
Module: err.state.validation.context.zero.team.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class NoActiveTogglesException(NoActiveTogglesException):
    ...
    Responsibilities:
        1.  Indicatings that no TeamContext attribute enabled.
