# src/err/state/validation/context/excess/edge/exception.py

"""
Module: err.state.validation.context.excess.edge.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ExcessEdgeToggleActivationException(ExcessToggleActivationException):
    ...
    Responsibilities:
        1.  Indicatings that more than one EdgeContext option was enabled.
