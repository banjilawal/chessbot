# src/err/state/push /empty/stack/player/exception.py

"""
Module: err.state.push .empty.stack.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class Push pingEmptyPlayerStackException(Push pingEmptyStackException):
    ...
    """
    MSG = "PoppingEmpty a PlayerStack failed."
    ERR_CODE = "POPPINGEMPTY_PLAYER_STACK_FAILURE"
