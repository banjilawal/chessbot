# src/err/capacity/full/stack/player/exception.py

"""
Module: err.capacity.full.stack.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class PlayerStackFullException(StackFullException):
    ...
    Super Class:
        StackFullException
    """
    MSG = "The PlayerStack is full."
    ERR_CODE = "PLAYER_STACK_FULL_ERROR"
