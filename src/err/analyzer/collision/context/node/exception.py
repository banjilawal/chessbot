# src/err/analyzer/collision/context/node/exception.py

"""
Module: err.analyzer.collision.context.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# NODE_CONTEXT_COLLISION_FAILURE #======================#
class NodeContextCollisionException(ContextCollisionException):
    """
    Role:
        -   Error Tracing
