# src/err/root/toggle/vector/exception.py

"""
Module: err.root.toggle.vector.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# VECTOR_TOGGLE_ROOT_CERTIFIER_FAILURE #======================#
class VectorToggleRootCertifierException(ToggleRootCertifierException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicate that a candidate failed a VectorToggleRootCertifier test.
