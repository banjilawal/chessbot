# src/err/transaction/deletion/player/exception.py

"""
Module: err.transaction.deletion.player.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class PoppingEmptyPlayerStackException(PoppingEmptyStackException):
    ...
    """
    MSG = "Cannot pop an empty Player stack."
    ERR_CODE = "POPPING_EMPTY_PLAYER_STACK_ERROR"
