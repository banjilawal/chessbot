# src/err/transaction/deletion/node/exception.py

"""
Module: err.transaction.deletion.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class EmptyNodeStackDeletionException(EmptyStackDeletionException):
    ...
    Responsibilities:
        1.  Indicates that popping An NodeStack failed because it was empty.
    ...
    """
    MSG = "Cannot pop an empty Node stack."
