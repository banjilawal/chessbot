# src/err/operator/crud/searcher/empty/checked/exception.py

"""
Module: rr.operator.crud.searcher.empty.checked.exception
Author: Banji Lawal
Created: 2026-04-04
version: 0.0.2
"""
...
class CheckedPathSearchResultEmptyException(PathSearchResultEmptyException):
    ...
    Responsibilities:
        1.  Indicating an CheckedPathSearcher did not find the required item.
