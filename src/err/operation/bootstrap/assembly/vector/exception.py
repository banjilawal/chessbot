...
__all__ = [
    # ======================# VECTOR_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
    "VectorAssemblyBootstrapperException",
]

# ======================# VECTOR_BOOTSTRAP_ASSEMBLY_FAILURE #======================#
class VectorAssemblyBootstrapperException(AssemblyBootstrapperException):
    """
    Role:
        -   Error Tracing
    ...
    """
    MSG = "VectorAssembly bootstrap step failed."
    ERR_CODE = "VECTOR_BOOTSTRAP_ASSEMBLY_FAILURE"
