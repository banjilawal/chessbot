# src/err/operation/validation/context/zero/node/__init__.py

"""
Module: err.operation.validation.context.zero.node.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ZeroNodeContextFlagsException(ZeroContextFlagsException):
    ...
    Responsibilities:
        1.  Indicates that no NodeContext attribute enabled.
