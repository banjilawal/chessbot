...
__all__ = [
    # ======================# VECTOR_TOGGLE_REGISTER_CARRIER_ERROR #======================#
    "VectorToggleRegisterCarrierException",
]

# ======================# VECTOR_TOGGLE_REGISTER_CARRIER_ERROR #======================#
class VectorToggleRegisterCarrierException(RegisterCarrierException):
    """
    Role:
        -   Error Tracing
    ...
    ERR_CODE = "VECTOR_TOGGLE_REGISTER_CARRIER_ERROR"
