# src/err/carrier/space/axis/east/exception.py

"""
Module: err.carrier.space.axisCarrier experienced an error.east.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class EastAxisCarrierException(AxisSpaceCarrierException):
    ...
    Responsibilities:
        1.  Indicate that a EastAxisCarrier experienced an error.
