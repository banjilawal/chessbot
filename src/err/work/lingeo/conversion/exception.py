# src/err/work/lingeo/conversion/work.py

"""
Module: err.work.lingeo.conversion.work
Author: Banji Lawal
Created: 2026-04-07
version: 1.0.0
"""
...
class LinGeoConversionException(LinGeoWorkException):
    ...
    Responsibilities:
        1.  Indicate that an error occurred during LinGeoConversion work.
    ...
    ERR_CODE = "LINGEO_CONVERSION_WORK_ERROR"
