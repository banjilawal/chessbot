# src/err/builder/space/axis/south/exception.py

"""
Module: err.builder.space.axisBuilder failed. south.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# SOUTH_AXIS_BUILDER_FAILURE #======================#
class SouthAxisBuilderException(AxisSpaceBuilderException):
    """
    Role:
        -   Failure Tracing
