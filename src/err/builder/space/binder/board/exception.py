# src/err/builder/model/BoardTeamBinder/exception.py

"""
Module: err.builder.model.BoardTeamBinder.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class BoardTeamBinderException(BinderException):
    ...
    Responsibilities:
        1.  Indicate that a BoardTeamBinder encountered an error.
