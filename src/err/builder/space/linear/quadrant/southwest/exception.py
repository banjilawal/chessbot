...
# ======================# SOUTHEAST_QUADRANT_BUILDER_FAILURE #======================#
class SoutheastQuadrantBuilderException(QuadrantBuilderException):
    """
    Role:
        -   Error Tracing

    Responsibilities:
        1.  Indicate that a SoutheastQuadrantSpaceBuilder failed.
    ...
    """
    MSG = "SoutheastQuadrantBuilder failed."
