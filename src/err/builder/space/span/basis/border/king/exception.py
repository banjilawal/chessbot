# src/err/builder/space/span/basis/border/king/exception.py

"""
Module: err.builder.space.span.basis.border.king.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# KING_BASIS_SET_BORDER_ERROR #======================#
class KingBasisSetBorderException(BasisSetBorderException):
    """
    Role:
        -   Error Tracing
