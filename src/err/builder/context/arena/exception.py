# src/err/builder/context/arena/exception.py

"""
Module: err.builder.context.arena.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class ArenaContextBuilderException(ContextBuilderException):
    ...
    Responsibilities:
        1.  Indicate that a ArenaContextBuilder failed.
   ...
   Builder failed.s:
    ...
    """
    MSG = "ArenaContextBuilder failed."
