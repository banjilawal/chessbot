# src/err/builder/context/token/exception.py

"""
Module: err.builder.context.token.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class TokenContextBuilderException(ContextBuilderException):
    ...
    Responsibilities:
        1.  Indicate that a TokenContextBuilder failed.
   ...
   Builder failed.s:
    ...
    """
    MSG = "TokenContextBuilder failed."
