# src/err/builder/context/board/exception.py

"""
Module: err.builder.context.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class BoardContextBuilderException(ContextBuilderException):
    ...
    Responsibilities:
        1.  Indicate that a BoardContextBuilder failed.
   ...
   Builder failed.s:
    ...
    """
    MSG = "BoardContextBuilder failed."
