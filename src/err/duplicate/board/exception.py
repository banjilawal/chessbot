# src/err/duplicate/board/exception.py

"""
Module: err.duplicate.board.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
class DuplicateBoardException(DuplicateItemException):
    ...
    """
    MSG = "Cannot push a duplicate Board onto the stack."
    ERR_CODE = "DUPLICATE_BOARD_ERROR"
