# src/err/analysis/collision/context/schema/exception.py

"""
Module: err.analysis.collision.context.schema.exception
Author: Banji Lawal
Created: 2026-04-04
version: 1.0.1
"""
...
# ======================# SCHEMA_CONTEXT_COLLISION_FAILURE #======================#
class SchemaContextCollisionException(ContextCollisionException):
    """
    Role:
        -   Error Tracing
