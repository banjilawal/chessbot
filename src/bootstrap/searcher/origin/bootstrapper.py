# src/bootstrap/searcher/origin/bootstrapper.py

"""
Module: bootstrap.searcher.origin.bootstrapper
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
from bootstrap import SearcherBootstrapper
from err import (
    DisabledTokenException, OriginSearcherBootstrapperException, TokenSearchHitConflictException,
    ...
    def execute(
        ...
        if readiness_analysis_result.is_failure:
            ...
            return SearchResult.failure(
                exception=OriginSearcherBootstrapperException(
                    cls_mthd=method,
                    cls_name=cls.__name__,
                    msg=OriginSearcherBootstrapperException.MSG,
                    err_code=OriginSearcherBootstrapperException.ERR_CODE,
        ...
        origin_search_result = target.team.board.squares.search(
