# src/chess/agent/entity_service/exception/invalid.py

"""
Module: chess.agent.entity_service.exception.invalid
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# AGENT_SERVICE VALIDATION EXCEPTIONS #======================#
class InvalidAgentServiceException(AgentServiceException, ValidationException):
    """
