...
__all__ = [
    #======================# AGENT_DATA_SERVICE VALIDATION EXCEPTION #======================#
...
class InvalidAgentDataServiceException(AgentDataServiceException, ValidationFailedException):
    ...
    # RESPONSIBILITIES:
    1.  Parent of exception raised during AgentDataService verification process.
    2.  Wraps unhandled exception that hit the try-finally block of an AgentDataServiceValidator method.
