# src/chess/square/event/validation/resource_candidate.py

"""
Module: chess.square.event.validation.resource_candidate
Author: Banji Lawal
Created: 2025-10-18
Version: 1.0.0
"""
  ...
  def validate(cls, candidate: Tuple[Square, Board]) -> ValidationResult[Tuple[Square, Board]]:
    ...
    try:
      ...
      if search_result.is_empty():
        return ValidationResult(exception=SquareInvariantBreachException(
          f"{method}: {SquareInvariantBreachException.DEFAULT_MESSAGE}"
        ))
