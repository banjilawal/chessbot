# src/chess/piece/travel/occupation/combatant/exception.py

"""
Module: chess.piece.travel.occupation.combatant.exception
Author: Banji Lawal
Created: 2025-10-24
version: 1.0.0
"""

from chess.piece import OccupationEventException, TravelEventException
...
class CombatantOccupationEventException(OccupationEventException):
  """
  A base class for all exceptions related to the CombatantOccupationEvent. Do not use directly. Subclasses provide
  fine-grained messages and error codes better for debugging and logging.
  """
  DEFAULT_CODE = "OCCUPATION_EVENT_ERROR"
  DEFAULT_MESSAGE = "An CombatantOccupationEvent raised an rollback_exception."
...
class AttackEventBuilderException(AttackEventException, BuilderException):
  ...
  DEFAULT_MESSAGE = "AttackEventBuilder failed to create combatantOccupationEvent"
