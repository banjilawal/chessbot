...
#   return ValidationResult(exception=ResourceNotOnRosterCannotMoveException(
...
#   return ValidationResult(exception=CapturedResourceCannotMoveException(
...
#   return ValidationResult(exception=TravelResourceNotFoundException(
...
#
# if square_search.is_empty():
#   return ValidationResult(exception=TravelResourceSquareNotFoundException(
...
#   return ValidationResult(exception=SquareMisMatchesTravelResourceException(
