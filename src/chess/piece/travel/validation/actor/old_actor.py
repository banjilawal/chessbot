...
from chess.piece import Piece, CombatantPiece, PieceValidator, ActorBindingBoardValidator
...
class OldTravelActorValidator:
  ...
  _binding_validator: ActorBindingBoardValidator

  def __init__(
    self,
    actor_validator: PieceValidator,
    environment_validator: BoardValidator,
    binding_validator: ActorBindingBoardValidator
  ):
  ...
  @classmethod
  def create_default(cls) -> 'OldTravelActorValidator':
  ...
  def validate(cls, actor_candidate: Any, environment_candidate: Any) -> ValidationResult[Piece]:
    """"""
    method = "OldTravelActorValidator.validate"
    ...
    try:
      ...
      binding_validation = ActorBindingBoardValidator.validate(piece, board)
