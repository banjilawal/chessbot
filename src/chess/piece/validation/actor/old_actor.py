...
from chess.piece import Piece, CombatantPiece, PieceValidator, PieceBindingBoardValidator
...
class OldTravelActorValidator:
  ...
  _binding_validator: PieceBindingBoardValidator

  def __init__(
    self,
    actor_validator: PieceValidator,
    environment_validator: BoardValidator,
    binding_validator: PieceBindingBoardValidator
  ):
  ...
  def validate(cls, actor_candidate: Any, environment_candidate: Any) -> ValidationResult[Piece]:
    ...
    try:
      ...
      binding_validation = PieceBindingBoardValidator.validate(piece, board)
