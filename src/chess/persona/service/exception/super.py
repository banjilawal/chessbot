# src/chess/persona/service/exception.super.py

"""
Module: chess.persona.service.exception.super
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# PERSONA_SERVICE EXCEPTION #======================#
class PersonaServiceException(ServiceException):
    """
    # ROLE: Exception Wrapper

    # RESPONSIBILITIES:
    1.  Wrap any exceptions raised by PersonaService methods that return Result objects.
