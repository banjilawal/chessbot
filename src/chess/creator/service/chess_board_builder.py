...
# from chess.geometry.visitor_coord.visitor_coord import Coord
...
#         visitor_coord = Coord(row=i, column=j)
#         square = Square(id_emitter.visitor_id, visitor_name, visitor_coord)
