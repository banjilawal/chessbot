# src/chess/squareContext/context/builder/exception/wrapper.py

"""
Module: chess.squareContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class SquareContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the SquareContextBuilder method where the process failed.
