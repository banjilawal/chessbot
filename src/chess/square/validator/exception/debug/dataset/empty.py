# src/chess/square/validator/exception/debug/dataset/empty.py

"""
Module: chess.square.validator.exception.debug.dataset.empty
Author: Banji Lawal
Created: 2026-02-23
"""
...
class SquareDataSourceEmptyException(SquareDebugException):
    ...
    DEFAULT_MESSAGE = "The dataset of squares cannot be empty"