# src/chess/square/service/menu/build/request/exception/debug.py

"""
Module: chess.square.service.menu.build.request.exception.debug
Author: Banji Lawal
Created: 2026-02-24
"""
...
from chess.square import DebugException, ServiceRequestException
