# src/chess/square/service/menu/execution/exception/debug.py

"""
Module: chess.square.service.menu.execution.exception.debug
Author: Banji Lawal
Created: 2026-02-24
"""
...
from chess.square import DebugException, ServiceExecutionException
