...
class SquareServiceException(ServiceException):
    """
    Super class of exceptions raised by SquareIntegrityService objects. Do not use directly. Subclasses give
    precise, fined-grained, debugging info.
    """
    ERROR_CODE = "SQUARE_SERVICE_ERROR"
    DEFAULT_MESSAGE = "SquareIntegrityService raised an exception."
...
class AddingDuplicateSquareException(ServiceException):
    ...
    DEFAULT_MESSAGE = "SquareIntegrityService cannot add duplicate Squares to the list."
...
class RemovingNonExistentSquareException(ServiceException):
    ...
    DEFAULT_MESSAGE = "SquareIntegrityService cannot remove a Square not in the list."