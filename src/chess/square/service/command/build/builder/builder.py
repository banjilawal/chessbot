...
class SquareBuildRequestBuilder(Builder[SquareBuildRequest]):
    """
    ...
    def build(
        ...
        """
        method = "SquareBuilRequestBuilder.builder"
    ...
    def _validate_build_params(
        ...
        None
        """
        method = "SquareBuilRequestBuilder._validate_build_params"
    ...
    def _build_square_board_relationship(
       ...
       # PARAMETERS:
        ...
        None
        """
        method = "SquareBuilRequestBuilder._build_square_board_relationship"
