# src/chess/token/context/exception/anchor.py

"""
Module: chess.token.context.exception.anchor
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
__all__ = [
    # ======================# TOKEN_CONTEXT_CONTEXT_EXCEPTION #======================#
...
class TokenContextException(AnchorException):
    ...
    """
    ERR_CODE = "TOKEN_CONTEXT_CONTEXT_EXCEPTION"
