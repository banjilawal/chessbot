# src/chess/token/context/validator/exception/debug/null.py

"""
Module: chess.token.context.validator.exception.debug.null
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class NullTokenContextException(NullException):
    ...
    # RESPONSIBILITIES:
    1.  Indicate that a token_context is null where it should not be.
