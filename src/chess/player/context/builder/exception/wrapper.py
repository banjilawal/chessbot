# src/chess/playerContext/context/builder/exception/wrapper.py

"""
Module: chess.playerContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class PlayerContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the PlayerContextBuilder method where the process failed.
