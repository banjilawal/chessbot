...
class EmptyResultConstructorException(ResultConstructorException):
    ...
    DEFAULT_MESSAGE = "A Result cannot be constructed with no payload or exception."
...
class ErrorContradictsPayloadException(ResultConstructorException):
    ...
    DEFAULT_MESSAGE = (
        "A Result cannot have both its payload and exception set. Construct with either payload or exception"
    )
