# src/chess/node/service/exception.super.py

"""
Module: chess.node.service.exception.super
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class NodeServiceException(ServiceException):
    ...
    # RESPONSIBILITIES:
    1.  Wrap any exceptions raised by NodeService methods that return Result objects.
