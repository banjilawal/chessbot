# src/chess/nodeContext/context/builder/exception/wrapper.py

"""
Module: chess.nodeContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class NodeContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the NodeContextBuilder method where the process failed.
