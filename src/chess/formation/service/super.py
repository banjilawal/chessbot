# src/chess/formation/service/exception.super.py

"""
Module: chess.formation.service.exception.super
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
# ======================# FORMATION_SERVICE_EXCEPTION #======================#
class FormationServiceException(SuperClassException):
    """
    # ROLE: DebugException Parent, Exception Chain Layer 0

    # RESPONSIBILITIES:
    1.  Indicate that an error occurred in a formationService.
