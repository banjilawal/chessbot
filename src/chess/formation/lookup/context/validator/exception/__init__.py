# src/chess/formation/lookup/context/number_bounds_validator/exception/__init__.py

"""
Module: chess.formation.lookup.context.number_bounds_validator.exception.__init__
Author: Banji Lawal
Created: 2025-10-09
version: 1.0.0
"""
