# src/chess/arena/context/number_bounds_validator/exception/base.py

"""
Module: chess.arena.arena.context.number_bounds_validator.exception.base
Author: Banji Lawal
Created: 2025-10-01
version: 1.0.0
"""
...
class InvalidArenaContextException(ArenaContextException, ValidationFailedException):
    ...
    2.  Wraps unhandled exceptions that hit the finally-block in ArenaContextValidator methods.
