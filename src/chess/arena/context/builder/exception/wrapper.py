# src/chess/arenaContext/context/builder/exception/wrapper.py

"""
Module: chess.arenaContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class ArenaContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the ArenaContextBuilder method where the process failed.
