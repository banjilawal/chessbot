...
# Purpose
Holds `Agent` instances and `Board` they play on. IntegrityService that team_name `Agent` uses
...
# SUB-PACKAGES
  - `.rollback_exception`: Defines all custom exceptions for `Arena` rollback.
