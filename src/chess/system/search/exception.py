...
class ImpossibleFatalResultException(SearchException):
  ...
  indicates service inconsistency or nonexistent service pool.
  """
  DEFAULT_CODE = "IMPOSSIBLE_FATAL_RESULT_ERROR"
  DEFAULT_MESSAGE = (
    "The search result should be impossible to get. This indicates a major service inconsistency or system error."
  )
...
class SearchCollisionException(SearchException):
  ...
  DEFAULT_MESSAGE = (
    "Search results contains multiple records for property that should be unique. There may be service inconsistencies."
  )
