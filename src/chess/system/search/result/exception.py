# src/chess/system/old_search/notification/travel_exception.py
...
__all__ = [
  'SearchResultBuildFailedException'
]

class SearchResultBuildFailedException(BuildFailedException):
  """
  ...
  DEFAULT_MESSAGE = "SearchResultBuild failed."
