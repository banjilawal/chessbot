# src/chess/system/validate/notification/rollback_exception.py

"""
Module: chess.system.validate.notification.rollback_exception
Author: Banji Lawal
Created: 2025-10-04
version: 1.0.0
...
from chess.system import BuildFailedException, ValidationException

__all__ = [
  'ValidationResultBuildFailedException'
]

class ValidationResultBuildFailedException(BuildFailedException):
  """
  ...
  """
  ERROR_CODE = "VALIDATION_RESULT_BUILD_FAILED"
  DEFAULT_MESSAGE = "ValidationResultBuild failed."
