...
state changes across the board, transactionResults, and teams. It serves as the **engine
...
CONTAINS:
--------
 * `TransactionResultBuilder`: The builder of `TransactionResult` instances.
"""
