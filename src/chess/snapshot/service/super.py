# src/chess/snapshot/service/exception.super.py

"""
Module: chess.snapshot.service.exception.super
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class SnapshotServiceException(ServiceException):
    ...
    # RESPONSIBILITIES:
    1.  Wrap any exceptions raised by SnapshotService methods that return Result objects.
