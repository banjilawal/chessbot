# src/chess/snapshot/context/builder/exception/wrapper.py

"""
Module: chess.snapshot.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class SnapshotContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Wrap debug exceptions indicating why a snapshot_context build operation failed. The exception chain
