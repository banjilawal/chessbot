...
class CurrentTeamInconsistentStateException(TeamStackException):
...
class DuplicateTeamPushException(TeamStackException):
    ERROR_CODE = "DUPLICATE_TEAM_PUSH_STACK_ERROR"
    DEFAULT_MESSAGE = "Cannot push duplicate team onto stack"
...
class NullTeamPushException(TeamStackException):
    ERROR_CODE = "NULL_TEAM_PUSH_STACK_ERROR"
    DEFAULT_MESSAGE = "Cannot push a null team onto the stack"
