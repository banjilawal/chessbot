...
from chess.rank import PawnVectorCategory, PawnAttackSpan, PawnDevelopedSpanComputationFailedException
...
class PawnDevelopedSpan:
    ...
    None
    """
    MOVEMENT_CATEGORY = PawnVectorCategory.DEVELOPED_MOVE
