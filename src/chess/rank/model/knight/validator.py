...
class KnightValidator(Validator[Knight]):
    ...
    def verify_id(
        ...
        2.  Check if id != Catalog.KNIGHT.id. If not, return failure.
    ...
    def verify_name(
        ...
        2.  Check if designation != Catalog.KNIGHT.designation. If not, return failure.
        3.  If all checks pass the id in a success validation result.
        ...
        # Finally, catch any missed exception and wrap An InvalidKnightException around it
        # then return the exception-chain inside a ValidationResult.
        except Exception as ex:
            return ValidationResult.failure(
                InvalidKnightException(ex=ex, message=f"{method}: {InvalidKnightException.DEFAULT_MESSAGE}")
    ...
    def verify_designation(
        ...
        2.  Check if string != Catalog.KNIGHT.designation. If not, return failure.
        3.  If all checks pass the id in a success validation result.
