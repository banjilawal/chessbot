# src/chess/rank/king/validator_.py

"""
Module: chess.rank.king.validator
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
class KingValidator(Validator[King]):
    ...
    def verify_name(
        ...
        try:
            ...
            # If no errors are detected send the verified king.name inside a ValidationResult.
    ...
    def verify_ransom(
        ...
        2.  Check if ransom != RankSpec.KING.ransom. If not, return failure.
        3.  If all checks pass the id in a success validation result.
    ...
    def verify_designation(
        ...
        2.  Check if string != RankSpec.KING.designation. If not, return failure.
        3.  If all checks pass the id in a success validation result.
    ...
    def verify_team_quota(
        ...
        # ACTION:
        1.  Verify candidate is a safe number using number_validator. If so convert to number. Else return failure.
        2.  Check if ransom != RankSpec.KING.team_quota. If not, return failure.
        3.  If all checks pass the id in a success validation result.
