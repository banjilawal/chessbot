# src/chess/rank/bishop/validator_.py

"""
Module: chess.rank.bishop.validator
Author: Banji Lawal
Created: 2025-09-08
version: 1.0.0
"""
...
class BishopValidator(Validator[Bishop]):
    ...
    def verify_id(
        ...
        2.  Check if id != RankSpec.BISHOP.id. If not, return failure.
    ...
    def verify_ransom(
        ...
        2.  Check if ransom != RankSpec.BISHOP.ransom. If not, return failure.
        3.  If all checks pass the id in a success validation result.
    ...
    def verify_designation(
        ...
        2.  Check if string != RankSpec.BISHOP.designation. If not, return failure.
        3.  If all checks pass the id in a success validation result.
    ...
    def verify_team_quota(
        ...
        # ACTION:
        1.  Verify candidate is a safe number using number_validator. If so convert to number. Else return failure.
        2.  Check if ransom != RankSpec.BISHOP.team_quota. If not, return failure.
        3.  If all checks pass the id in a success validation result.
