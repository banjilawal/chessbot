...
class VisitationException(ChessException):
    """
...
# ======================# VISITATION VALIDATION EXCEPTIONS #======================#
class InvalidVisitationException(VisitationException, ValidationException):
...
class VisitationTeamFieldIsNullException(VisitationException, InconsistencyException):
    """
...
class VisitationMissingCoordStackException(VisitationException, InconsistencyException):
    """
...
class VisitationMissingDiscoveriesException(VisitationException, InconsistencyException):
    """
...
class UnregisteredTeamMemberException(VisitationException):
...
class VisitationRosterNumberIsNullException(VisitationException, NullException):
    """
...
class VisitationRankOutOfBoundsException(VisitationException, NullException):
    """
...
# ======================# NULL VISITATION EXCEPTIONS #======================#
class NullVisitationException(VisitationException, NullException):
    """
...
class NullKingException(NullVisitationException):
    """
...
class NullCombatantException(NullVisitationException):
    """
...
# ======================# VISITATION BUILD EXCEPTIONS #======================#  
class VisitationBuildFailedException(VisitationException, BuilderException):
    """
