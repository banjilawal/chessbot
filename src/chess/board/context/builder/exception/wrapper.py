# src/chess/boardContext/context/builder/exception/wrapper.py

"""
Module: chess.boardContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class BoardContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the BoardContextBuilder method where the process failed.
