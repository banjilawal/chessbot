# src/chess/board/service/data/unique/exception/deletion/wrapper.py

"""
Module: chess.board.service.data.unique.exception.deletion.wrapper
Author: Banji Lawal
Created: 2025-11-19
version: 1.0.0
"""
...
class ExhaustiveBoardDeletionFailedException(BoardException, DeletionFailedException):
    ...
    # RESPONSIBILITIES:
    1.  Wrap debug exceptions that indicate why deleting all occurrences of a board failed. deletion fails. The
