# src/chess/board/validator/exception/wrapper.py

"""
Module: chess.board.validator.exception.wrapper
Author: Banji Lawal
Created: 2025-09-08
Version: 1.0.0
"""
...
class BoardValidationException(ValidationException):
    ...
    # RESPONSIBILITIES:
    1.  Indicate that a candidate failed a safety check in a BoardValidator method.
   ...
   None
    ...
    """
    ERR_CODE = "BOARD_BOARD_VALIDATION_FAILURE"
