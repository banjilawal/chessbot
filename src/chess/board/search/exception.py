...
class CoordSearchInvariantBreachException(BoardException, InvariantBreachException):
  ...
  DEFAULT_MESSAGE = (
    "The Board's Coord invariant was breached, There may be a critical state inconsistency. or entity_service loss."
  )
...
class SquareInvariantBreachException(BoardException, InvariantBreachException):
  ...
  DEFAULT_MESSAGE = (
    "The Board's Square invariant was breached, There may be a critical state inconsistency. or entity_service loss."
  )
