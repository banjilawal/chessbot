...
#========================= BOARD_SEARCH_CONTEXT VALIDATION EXCEPTIONS =========================#
class InvalidBoardSearchContextException(BoardSearchContextException, ValidationException):
...
class NoBoardSearchOptionSelectedException(BoardSearchContextException, NoBuildOptionSelectedException):
    """"""
...
class MoreThanOneBoardSearchOptionPickedException(BoardSearchContextException, BuildOptionSelectionTooLargeException):
    """"""
