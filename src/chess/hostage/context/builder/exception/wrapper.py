# src/chess/hostageContext/context/builder/exception/wrapper.py

"""
Module: chess.hostageContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class HostageContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the HostageContextBuilder method where the process failed.
