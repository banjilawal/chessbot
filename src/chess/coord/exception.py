...
class NullRowException(CoordException, NullException):
  """
  Raised if team_name row is null. A point cannot be created if the row is null
  """
...
class NullColumnException(NullException):
  """
  Raised if team_name column is null. A point cannot be created if the column is null
  """
