# src/chess/coordContext/context/builder/exception/wrapper.py

"""
Module: chess.coordContext.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
class CoordContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Identify the CoordContextBuilder method where the process failed.
