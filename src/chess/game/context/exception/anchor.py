# src/chess/game/context/exception/anchor.py

"""
Module: chess.game.context.exception.anchor
Author: Banji Lawal
Created: 2025-09-16
version: 1.0.0
"""
...
__all__ = [
    # ======================# GAME_CONTEXT_CONTEXT_EXCEPTION #======================#
...
class GameContextException(AnchorException):
    ...
    """
    ERR_CODE = "GAME_CONTEXT_CONTEXT_EXCEPTION"
