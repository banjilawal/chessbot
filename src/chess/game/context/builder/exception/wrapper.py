# src/chess/game/context/builder/exception/wrapper.py

"""
Module: chess.game.context.builder.exception.wrapper
Author: Banji Lawal
Created: 2025-10-03
version: 1.0.0
"""
...
class GameContextBuildException(BuildException):
    ...
    # RESPONSIBILITIES:
    1.  Wrap debug exceptions indicating why a game_context build operation failed. The exception chain
