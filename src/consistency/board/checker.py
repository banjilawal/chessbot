# src/consistency/board/consistency.py

"""
Module: consistency.board.consistency
Author: Banji Lawal
Created: 2026-04-03
version: 1.0.1
"""
...
class BoardConsistencyChecker(ConsistencyChecker[Board]):
    """
    ...
    None
    """
    OPERATION_NAME = "board_consistency"
    ...
    def _validate_arena(cls, board: Board, arena_service: ArenaService = ArenaService() ) -> ValidationResult[Arena]:
        ...
        *   BoardConsistencyCheckerException
        ...
        # On certification successes send the board back to the consistency.
