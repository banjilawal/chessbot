...
if __name__ == "__main__":
    ...
    board.add_new_entity(GridCoordinate(row=9, column=9), horizontal_mover_a)
    print("moverA coord", horizontal_mover_a.top_left_coordinate)

    mover_a_cells = board.get_cells_occupied_by_entity(horizontal_mover_a)
    print("moverA cells:", mover_a_cells)

    horizontal_mover_a.move(board, GridCoordinate(row=9, column=12))
    print("moverA coord", horizontal_mover_a.top_left_coordinate)
    ...
    board.add_new_entity(GridCoordinate(row=0, column=0), horizontal_mover_b)
    print("moverB coord", horizontal_mover_b.top_left_coordinate)
    horizontal_mover_b.move(board, GridCoordinate(row=0, column=1))
    print("moverB coord", horizontal_mover_b.top_left_coordinate)
    ...
    board.add_new_entity(GridCoordinate(row=6, column=6), vertical_mover_u)
    print("moverU coord:", vertical_mover_u.top_left_coordinate)
