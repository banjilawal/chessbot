...
class GameBoardSquare:
    ...
    def occupy(self, game_piece: GameFigure):
        """
        Marks the square as occupied by a piece or player.

        :param game_piece: The object or identifier representing the occupant.
        """
        ...
        if self._occupant.__eq__(game_piece):
            return

        self.occupant = game_piece
